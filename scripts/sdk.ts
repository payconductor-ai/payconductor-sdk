...
const generateSdk = async (version: string, languages: string[]) => {
  ...
  for (const lang of languages) {
    ...
    const proc = await Bun.spawn([
      ...
      "--skip-validate-spec",
      "--additional-properties=packageName=payconductor_sdk,projectName=payconductor-sdk,npmName=@payconductor/sdk,npmVersion=1.0.2,licenseName=MIT,gitUserId=payconductor-ai,gitRepoId=payconductor-sdk,gitHost=github.com",
    ]);
