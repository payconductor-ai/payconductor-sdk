...
CustomersApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return void
    GetCustomers = function(page, page_size, email = NULL, name = NULL, end_date = NULL, start_date = NULL, ...) {
      local_var_response <- self$GetCustomersWithHttpInfo(page, page_size, email, name, end_date, start_date, ...)
    ...
    GetCustomersWithHttpInfo = function(page, page_size, email = NULL, name = NULL, end_date = NULL, start_date = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
