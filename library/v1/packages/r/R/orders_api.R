...
OrdersApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return void
    GetOrders = function(page, page_size, end_date = NULL, start_date = NULL, id = NULL, status = NULL, ...) {
      local_var_response <- self$GetOrdersWithHttpInfo(page, page_size, end_date, start_date, id, status, ...)
    ...
    GetOrdersWithHttpInfo = function(page, page_size, end_date = NULL, start_date = NULL, id = NULL, status = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @param id 
    #' @param post_orders_request_payment Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return PostOrdersByIdConfirm200Response
    PostOrdersByIdConfirm = function(id, post_orders_request_payment, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$PostOrdersByIdConfirmWithHttpInfo(id, post_orders_request_payment, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (PostOrdersByIdConfirm200Response) with additional information such as HTTP status code, headers
    PostOrdersByIdConfirmWithHttpInfo = function(id, post_orders_request_payment, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`post_orders_request_payment`)) {
        stop("Missing required parameter `post_orders_request_payment`.")
      }

      if (!missing(`id`) && is.null(`id`)) {
        stop("Invalid value for `id` when calling OrdersApi$PostOrdersByIdConfirm, `id` is not nullable")
      }

      if (!missing(`post_orders_request_payment`) && is.null(`post_orders_request_payment`)) {
        stop("Invalid value for `post_orders_request_payment` when calling OrdersApi$PostOrdersByIdConfirm, `post_orders_request_payment` is not nullable")
      }

      if (!is.null(`post_orders_request_payment`)) {
        local_var_body <- `post_orders_request_payment`$toJSONString()
      } else {
        local_var_body <- NULL
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "PostOrdersByIdConfirm200Response"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
