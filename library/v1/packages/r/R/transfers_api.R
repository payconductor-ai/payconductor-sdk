...
#' @export
TransfersApi <- R6::R6Class(
  "TransfersApi",
  public = list(
    api_client = NULL,

    #' @description
    #' Initialize a new TransfersApi.
    #'
    ...
    #'
    #' @return void
    GetWithdraws = function(page, page_size, end_date = NULL, start_date = NULL, id = NULL, ...) {
      local_var_response <- self$GetWithdrawsWithHttpInfo(page, page_size, end_date, start_date, id, ...)
    ...
    GetWithdrawsWithHttpInfo = function(page, page_size, end_date = NULL, start_date = NULL, id = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!missing(`page`) && is.null(`page`)) {
        stop("Invalid value for `page` when calling TransfersApi$GetWithdraws, `page` is not nullable")
      }
      if (!is.null(`page`) && `page` <  1) {
        stop("Invalid value for `page` when calling TransfersApi$GetWithdraws, must be bigger than or equal to 1.")
      }

      if (!missing(`page_size`) && is.null(`page_size`)) {
        stop("Invalid value for `page_size` when calling TransfersApi$GetWithdraws, `page_size` is not nullable")
      }
      if (!is.null(`page_size`) && `page_size` >  100) {
        stop("Invalid value for `page_size` when calling TransfersApi$GetWithdraws, must be smaller than or equal to 100.")
      }
      if (!is.null(`page_size`) && `page_size` <  1) {
        stop("Invalid value for `page_size` when calling TransfersApi$GetWithdraws, must be bigger than or equal to 1.")
      }

      if (!missing(`end_date`) && is.null(`end_date`)) {
        stop("Invalid value for `end_date` when calling TransfersApi$GetWithdraws, `end_date` is not nullable")
      }

      if (!missing(`start_date`) && is.null(`start_date`)) {
        stop("Invalid value for `start_date` when calling TransfersApi$GetWithdraws, `start_date` is not nullable")
      }

      if (!missing(`id`) && is.null(`id`)) {
        stop("Invalid value for `id` when calling TransfersApi$GetWithdraws, `id` is not nullable")
      }
    ...
    GetWithdrawsByIdWithHttpInfo = function(id, ...) {
      ...
      if (!missing(`id`) && is.null(`id`)) {
        stop("Invalid value for `id` when calling TransfersApi$GetWithdrawsById, `id` is not nullable")
      }
    ...
    PostWithdrawsWithHttpInfo = function(post_withdraws_request, data_file = NULL, ..., .parse = TRUE) {
      ...
      if (!missing(`post_withdraws_request`) && is.null(`post_withdraws_request`)) {
        stop("Invalid value for `post_withdraws_request` when calling TransfersApi$PostWithdraws, `post_withdraws_request` is not nullable")
      }
