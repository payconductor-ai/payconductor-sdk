...
# **GetWithdraws**
> GetWithdraws(page, page_size, end_date = var.end_date, start_date = var.start_date, id = var.id)
...
api_instance$GetWithdraws(var_page, var_page_size, end_date = var_end_date, start_date = var_start_date, id = var_id)
```
