...
--[[
Unit tests for payconductor_sdk.model.credit_card_card
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("credit_card_card", function()
  local payconductor_sdk_credit_card_card = require "payconductor_sdk.model.credit_card_card"

  -- unit tests for the property 'first_six_card_number'
  describe("property first_six_card_number test", function()
  ...
  -- unit tests for the property 'cvv'
  describe("property cvv test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
  ...
  -- unit tests for the property 'holder_name'
  describe("property holder_name test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
