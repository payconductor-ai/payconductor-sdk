...
--[[
Unit tests for payconductor_sdk.model.post_orders_200_response_nu_pay
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("post_orders_200_response_nu_pay", function()
  local payconductor_sdk_post_orders_200_response_nu_pay = require "payconductor_sdk.model.post_orders_200_response_nu_pay"

  -- unit tests for the property 'payment_url'
  describe("property payment_url test", function()
