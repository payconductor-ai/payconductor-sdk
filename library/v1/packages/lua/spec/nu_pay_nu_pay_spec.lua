...
--[[
Unit tests for payconductor_sdk.model.nu_pay_nu_pay
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("nu_pay_nu_pay", function()
  local payconductor_sdk_nu_pay_nu_pay = require "payconductor_sdk.model.nu_pay_nu_pay"
  ...
  -- unit tests for the property 'merchant_name'
  describe("property merchant_name test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
