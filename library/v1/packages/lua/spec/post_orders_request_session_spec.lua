...
--[[
Unit tests for payconductor_sdk.model.post_orders_request_session
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("post_orders_request_session", function()
  local payconductor_sdk_post_orders_request_session = require "payconductor_sdk.model.post_orders_request_session"

  -- unit tests for the property 'expires_in_minutes'
  describe("property expires_in_minutes test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'checkout_url'
  describe("property checkout_url test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
  ...
  -- unit tests for the property 'external_session_id'
  describe("property external_session_id test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
