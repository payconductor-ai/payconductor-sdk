...
--[[
Unit tests for payconductor_sdk.model.draft_available_payment_methods_inner
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("draft_available_payment_methods_inner", function()
  local payconductor_sdk_draft_available_payment_methods_inner = require "payconductor_sdk.model.draft_available_payment_methods_inner"
