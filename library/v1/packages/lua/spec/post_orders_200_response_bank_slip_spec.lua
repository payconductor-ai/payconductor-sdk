...
--[[
Unit tests for payconductor_sdk.model.post_orders_200_response_bank_slip
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("post_orders_200_response_bank_slip", function()
  local payconductor_sdk_post_orders_200_response_bank_slip = require "payconductor_sdk.model.post_orders_200_response_bank_slip"

  -- unit tests for the property 'bar_code'
  describe("property bar_code test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'digitable_line'
  describe("property digitable_line test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'pdf_url'
  describe("property pdf_url test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
