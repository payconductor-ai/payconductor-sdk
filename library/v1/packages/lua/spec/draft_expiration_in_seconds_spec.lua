...
--[[
Unit tests for payconductor_sdk.model.draft_expiration_in_seconds
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("draft_expiration_in_seconds", function()
  local payconductor_sdk_draft_expiration_in_seconds = require "payconductor_sdk.model.draft_expiration_in_seconds"
