...
--[[
Unit tests for payconductor_sdk.model.post_orders_request_payment
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("post_orders_request_payment", function()
  ...
  -- unit tests for the property 'expiration_in_seconds'
  describe("property expiration_in_seconds test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'card'
  describe("property card test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'installments'
  describe("property installments test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'soft_descriptor'
  describe("property soft_descriptor test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'expiration_in_days'
  describe("property expiration_in_days test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
  ...
  -- unit tests for the property 'available_payment_methods'
  describe("property available_payment_methods test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
