...
--[[
Unit tests for payconductor_sdk.model.post_orders_request_items_inner
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("post_orders_request_items_inner", function()
  local payconductor_sdk_post_orders_request_items_inner = require "payconductor_sdk.model.post_orders_request_items_inner"
  ...
  -- unit tests for the property 'is_physical'
  describe("property is_physical test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
