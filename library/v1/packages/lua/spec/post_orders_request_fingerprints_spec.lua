...
--[[
Unit tests for payconductor_sdk.model.post_orders_request_fingerprints
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("post_orders_request_fingerprints", function()
  local payconductor_sdk_post_orders_request_fingerprints = require "payconductor_sdk.model.post_orders_request_fingerprints"

  -- unit tests for the property 'threat_metrix_fingerprint_id'
  describe("property threat_metrix_fingerprint_id test", function()
