...
--[[
Unit tests for payconductor_sdk.model.available_payment_methods
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("available_payment_methods", function()
  local payconductor_sdk_available_payment_methods = require "payconductor_sdk.model.available_payment_methods"
