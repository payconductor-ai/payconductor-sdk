...
--[[
Unit tests for payconductor_sdk.api.transfers_api
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("transfers_api", function()
  local payconductor_sdk_transfers_api = require "payconductor_sdk.api.transfers_api"
  -- unit tests for get_withdraws
  describe("get_withdraws test", function()
  ...
  describe("get_withdraws_by_id test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
  ...
  describe("post_withdraws test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
