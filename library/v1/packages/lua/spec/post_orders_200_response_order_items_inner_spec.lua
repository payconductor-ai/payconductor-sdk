...
--[[
Unit tests for payconductor_sdk.model.post_orders_200_response_order_items_inner
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("post_orders_200_response_order_items_inner", function()
  local payconductor_sdk_post_orders_200_response_order_items_inner = require "payconductor_sdk.model.post_orders_200_response_order_items_inner"
  ...
  -- unit tests for the property 'total_amount'
  describe("property total_amount test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'total_net_amount'
  describe("property total_net_amount test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'unity_price'
  describe("property unity_price test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
