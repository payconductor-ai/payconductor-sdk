...
--[[
Unit tests for payconductor_sdk.model.pix_expiration_in_seconds
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("pix_expiration_in_seconds", function()
  local payconductor_sdk_pix_expiration_in_seconds = require "payconductor_sdk.model.pix_expiration_in_seconds"
