...
--[[
Unit tests for payconductor_sdk.model.post_orders_200_response_pix
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("post_orders_200_response_pix", function()
  local payconductor_sdk_post_orders_200_response_pix = require "payconductor_sdk.model.post_orders_200_response_pix"

  -- unit tests for the property 'copy_and_paste_code'
  describe("property copy_and_paste_code test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'qr_code_url'
  describe("property qr_code_url test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'end_to_end_id'
  describe("property end_to_end_id test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
