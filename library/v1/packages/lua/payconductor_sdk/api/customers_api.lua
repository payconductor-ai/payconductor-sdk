...
-- model import
local payconductor_sdk_customer = require "payconductor_sdk.model.customer"
local payconductor_sdk_customer_1 = require "payconductor_sdk.model.customer_1"
...
function customers_api:get_customers(page, page_size, email, name, end_date, start_date)
