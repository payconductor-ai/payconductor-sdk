...
-- available_payment_methods class
local available_payment_methods = {}
local available_payment_methods_mt = {
	__name = "available_payment_methods";
	__index = available_payment_methods;
}

local function cast_available_payment_methods(t)
	return setmetatable(t, available_payment_methods_mt)
end

local function new_available_payment_methods()
	return cast_available_payment_methods({
	})
end

return {
	cast = cast_available_payment_methods;
	new = new_available_payment_methods;
}
