...
-- draft_expiration_in_seconds class
local draft_expiration_in_seconds = {}
local draft_expiration_in_seconds_mt = {
	__name = "draft_expiration_in_seconds";
	__index = draft_expiration_in_seconds;
}

local function cast_draft_expiration_in_seconds(t)
	return setmetatable(t, draft_expiration_in_seconds_mt)
end

local function new_draft_expiration_in_seconds()
	return cast_draft_expiration_in_seconds({
	})
end

return {
	cast = cast_draft_expiration_in_seconds;
	new = new_draft_expiration_in_seconds;
}
