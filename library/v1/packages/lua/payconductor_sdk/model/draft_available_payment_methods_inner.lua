...
-- draft_available_payment_methods_inner class
local draft_available_payment_methods_inner = {}
local draft_available_payment_methods_inner_mt = {
	__name = "draft_available_payment_methods_inner";
	__index = draft_available_payment_methods_inner;
}

local function cast_draft_available_payment_methods_inner(t)
	return setmetatable(t, draft_available_payment_methods_inner_mt)
end

local function new_draft_available_payment_methods_inner()
	return cast_draft_available_payment_methods_inner({
	})
end

return {
	cast = cast_draft_available_payment_methods_inner;
	new = new_draft_available_payment_methods_inner;
}
