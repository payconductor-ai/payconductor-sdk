...
local payment_method_mt = {
	__name = "payment_method";
	__index = payment_method;
}

local function cast_payment_method(t)
	return setmetatable(t, payment_method_mt)
end

local function new_payment_method()
	return cast_payment_method({
	})
end

return {
	cast = cast_payment_method;
