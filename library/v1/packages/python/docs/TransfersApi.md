...
# **get_withdraws**
> get_withdraws(page, page_size, end_date=end_date, start_date=start_date, id=id)
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = payconductor_sdk.TransfersApi(api_client)
    ...
    try:
        # List withdrawals
        api_instance.get_withdraws(page, page_size, end_date=end_date, start_date=start_date, id=id)
    except Exception as e:
        print("Exception when calling TransfersApi->get_withdraws: %s\n" % e)
```
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TransfersApi->get_withdraws_by_id: %s\n" % e)
```
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = payconductor_sdk.TransfersApi(api_client)
    post_withdraws_request = payconductor_sdk.PostWithdrawsRequest() # PostWithdrawsRequest | 

    try:
        # Create withdrawal
        api_response = api_instance.post_withdraws(post_withdraws_request)
        print("The response of TransfersApi->post_withdraws:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TransfersApi->post_withdraws: %s\n" % e)
```
