...
# **get_orders**
> get_orders(page, page_size, end_date=end_date, start_date=start_date, id=id, status=status)
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = payconductor_sdk.OrdersApi(api_client)
    ...
    try:
        # List orders
        api_instance.get_orders(page, page_size, end_date=end_date, start_date=start_date, id=id, status=status)
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = payconductor_sdk.OrdersApi(api_client)
    post_orders_request = payconductor_sdk.PostOrdersRequest() # PostOrdersRequest | 
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = payconductor_sdk.OrdersApi(api_client)
    id = 'id_example' # str | 
    post_orders_request_payment = payconductor_sdk.PostOrdersRequestPayment() # PostOrdersRequestPayment | Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)

    try:
        # Confirm order
        api_response = api_instance.post_orders_by_id_confirm(id, post_orders_request_payment)
        print("The response of OrdersApi->post_orders_by_id_confirm:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OrdersApi->post_orders_by_id_confirm: %s\n" % e)
```
