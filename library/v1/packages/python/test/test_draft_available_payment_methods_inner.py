...
class TestDraftAvailablePaymentMethodsInner(unittest.TestCase):
    """DraftAvailablePaymentMethodsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DraftAvailablePaymentMethodsInner:
        """Test DraftAvailablePaymentMethodsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DraftAvailablePaymentMethodsInner`
        """
        model = DraftAvailablePaymentMethodsInner()
        if include_optional:
            return DraftAvailablePaymentMethodsInner(
            )
        else:
            return DraftAvailablePaymentMethodsInner(
        )
    ...
    def testDraftAvailablePaymentMethodsInner(self):
        """Test DraftAvailablePaymentMethodsInner"""
