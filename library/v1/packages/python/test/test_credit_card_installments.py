...
class TestCreditCardInstallments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreditCardInstallments:
        """Test CreditCardInstallments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditCardInstallments`
        """
        model = CreditCardInstallments()
        if include_optional:
    ...
    def testCreditCardInstallments(self):
        """Test CreditCardInstallments"""
