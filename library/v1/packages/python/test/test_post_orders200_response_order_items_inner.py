...
class TestPostOrders200ResponseOrderItemsInner(unittest.TestCase):
    """PostOrders200ResponseOrderItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostOrders200ResponseOrderItemsInner:
        """Test PostOrders200ResponseOrderItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOrders200ResponseOrderItemsInner`
        """
        model = PostOrders200ResponseOrderItemsInner()
        if include_optional:
            return PostOrders200ResponseOrderItemsInner(
                external_id = '',
                id = '',
                name = '',
                qty = 1.337,
    ...
    def testPostOrders200ResponseOrderItemsInner(self):
        """Test PostOrders200ResponseOrderItemsInner"""
