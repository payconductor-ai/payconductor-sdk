...
class TestCustomer2DocumentType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Customer2DocumentType:
        """Test Customer2DocumentType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Customer2DocumentType`
        """
        model = Customer2DocumentType()
        if include_optional:
            return Customer2DocumentType(
            )
        else:
            return Customer2DocumentType(
        )
    ...
    def testCustomer2DocumentType(self):
        """Test Customer2DocumentType"""
