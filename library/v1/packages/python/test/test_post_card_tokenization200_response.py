...
class TestPostCardTokenization200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostCardTokenization200Response:
        """Test PostCardTokenization200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostCardTokenization200Response`
        """
        model = PostCardTokenization200Response()
        if include_optional:
    ...
    def testPostCardTokenization200Response(self):
        """Test PostCardTokenization200Response"""
