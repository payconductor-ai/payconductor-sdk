...
class TestCompleteCardDataExpiration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CompleteCardDataExpiration:
        """Test CompleteCardDataExpiration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompleteCardDataExpiration`
        """
        model = CompleteCardDataExpiration()
        if include_optional:
            return CompleteCardDataExpiration(
                month = 1,
                year = 2025
            )
        else:
    ...
    def testCompleteCardDataExpiration(self):
        """Test CompleteCardDataExpiration"""
