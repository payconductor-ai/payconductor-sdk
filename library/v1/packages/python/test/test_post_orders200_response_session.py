...
class TestPostOrders200ResponseSession(unittest.TestCase):
    """PostOrders200ResponseSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostOrders200ResponseSession:
        """Test PostOrders200ResponseSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOrders200ResponseSession`
        """
        model = PostOrders200ResponseSession()
        if include_optional:
            return PostOrders200ResponseSession(
                session_id = ''
            )
        else:
            return PostOrders200ResponseSession(
    ...
    def testPostOrders200ResponseSession(self):
        """Test PostOrders200ResponseSession"""
