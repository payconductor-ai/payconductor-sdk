...
class TestDraftExpirationInSeconds(unittest.TestCase):
    """DraftExpirationInSeconds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DraftExpirationInSeconds:
        """Test DraftExpirationInSeconds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DraftExpirationInSeconds`
        """
        model = DraftExpirationInSeconds()
        if include_optional:
            return DraftExpirationInSeconds(
            )
        else:
            return DraftExpirationInSeconds(
        )
    ...
    def testDraftExpirationInSeconds(self):
        """Test DraftExpirationInSeconds"""
