...
class TestOrdersApi(unittest.TestCase):
    ...
    def test_get_orders_by_id(self) -> None:
        """Test case for get_orders_by_id

        Get order by ID
        """
        pass

    def test_post_orders(self) -> None:
    ...
    def test_post_orders_by_id_confirm(self) -> None:
        """Test case for post_orders_by_id_confirm

        Confirm order
        """
        pass

    def test_post_orders_by_id_refund(self) -> None:
        """Test case for post_orders_by_id_refund
