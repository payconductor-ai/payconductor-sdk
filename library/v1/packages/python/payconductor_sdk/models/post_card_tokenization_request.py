...
class PostCardTokenizationRequest(BaseModel):
    """
    Data for creating a customer card
    """ # noqa: E501
    card: CompleteCardData
    save_card: StrictBool = Field(description="Indicates if the card should be saved for future use", alias="saveCard")
    customer: PostCardTokenizationRequestCustomer
    __properties: ClassVar[List[str]] = ["card", "saveCard", "customer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "card": CompleteCardData.from_dict(obj["card"]) if obj.get("card") is not None else None,
            "saveCard": obj.get("saveCard"),
            "customer": PostCardTokenizationRequestCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
        return _obj
