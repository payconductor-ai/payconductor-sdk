...
class PostCardTokenizationRequestCustomer(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        # validate data type: PostCardTokenizationRequestCustomerAnyOf
        if not isinstance(v, PostCardTokenizationRequestCustomerAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PostCardTokenizationRequestCustomerAnyOf`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_2_validator: Optional[PostCardTokenizationRequestCustomerAnyOf] = None
        try:
            instance.actual_instance = PostCardTokenizationRequestCustomerAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
