...
class Customer2(BaseModel):
    ...
    document_type: Customer2DocumentType = Field(alias="documentType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documentType": Customer2DocumentType.from_dict(obj["documentType"]) if obj.get("documentType") is not None else None,
            "email": obj.get("email"),
            "name": obj.get("name"),
