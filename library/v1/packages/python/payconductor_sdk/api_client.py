...
from payconductor_sdk.configuration import Configuration
from payconductor_sdk.api_response import ApiResponse, T as ApiResponseT
import payconductor_sdk.models
from payconductor_sdk import rest
from payconductor_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(payconductor_sdk.models, klass)
