...
class OrdersApi:
    ...
    @validate_call
    def post_orders_by_id_confirm(
        self,
        id: StrictStr,
        post_orders_request_payment: Annotated[PostOrdersRequestPayment, Field(description="Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: str
        :param post_orders_request_payment: Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...) (required)
        :type post_orders_request_payment: PostOrdersRequestPayment
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_orders_by_id_confirm_serialize(
            id=id,
            post_orders_request_payment=post_orders_request_payment,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostOrdersByIdConfirm200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def post_orders_by_id_confirm_with_http_info(
        self,
        id: StrictStr,
        post_orders_request_payment: Annotated[PostOrdersRequestPayment, Field(description="Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostOrdersByIdConfirm200Response]:
        """Confirm order
    ...
    @validate_call
    def post_orders_by_id_confirm_without_preload_content(
        self,
        id: StrictStr,
        post_orders_request_payment: Annotated[PostOrdersRequestPayment, Field(description="Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)")],
        _request_timeout: Union[
    ...
    def _post_orders_by_id_confirm_serialize(
        self,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if post_orders_request_payment is not None:
            _body_params = post_orders_request_payment
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/orders/{id}/confirm',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
