...
void main() {
  ...
  group(OrdersApi, () {
    ...
    //
    //Future getOrders(num page, num pageSize, { DateTime endDate, DateTime startDate, String id, String status }) async
    ...
    //
    //Future<PostOrdersByIdConfirm200Response> postOrdersByIdConfirm(String id, PostOrdersRequestPayment postOrdersRequestPayment) async
    test('test postOrdersByIdConfirm', () async {
      // TODO
    });
