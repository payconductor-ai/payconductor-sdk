...
final api = Openapi().getTransfersApi();
...
try {
    api.getWithdraws(page, pageSize, endDate, startDate, id);
} on DioException catch (e) {
    print('Exception when calling TransfersApi->getWithdraws: $e\n');
}
```
...
try {
    ...
    print('Exception when calling TransfersApi->getWithdrawsById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling TransfersApi->postWithdraws: $e\n');
}
```
