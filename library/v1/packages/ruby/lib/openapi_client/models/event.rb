...
module OpenapiClient
  class Event
    OrderCreated = "OrderCreated".freeze
    OrderPending = "OrderPending".freeze
    OrderCompleted = "OrderCompleted".freeze
    OrderFailed = "OrderFailed".freeze
    OrderRefunded = "OrderRefunded".freeze
    OrderChargeback = "OrderChargeback".freeze
    WithdrawCreated = "WithdrawCreated".freeze
    WithdrawCompleted = "WithdrawCompleted".freeze
    WithdrawFailed = "WithdrawFailed".freeze
    WithdrawTransferring = "WithdrawTransferring".freeze

    def self.all_vars
      @all_vars ||= [OrderCreated, OrderPending, OrderCompleted, OrderFailed, OrderRefunded, OrderChargeback, WithdrawCreated, WithdrawCompleted, WithdrawFailed, WithdrawTransferring].freeze
    end
    ...
    def build_from_hash(value)
      return value if Event.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #Event"
    end
  end
end
