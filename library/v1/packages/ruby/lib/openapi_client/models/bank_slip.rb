  ...
  class BankSlip < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::BankSlip` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::BankSlip`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expiration_in_days')
        self.expiration_in_days = attributes[:'expiration_in_days']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          expiration_in_days == o.expiration_in_days
    end
    ...
    def hash
      [payment_method, expiration_in_days].hash
    end
