...
module OpenapiClient
  class Pix < ApiModelBase
    ...
    def self.openapi_types
      {
        :'payment_method' => :'PaymentMethod',
        :'expiration_in_seconds' => :'PixExpirationInSeconds'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Pix` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Pix`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expiration_in_seconds')
        self.expiration_in_seconds = attributes[:'expiration_in_seconds']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          expiration_in_seconds == o.expiration_in_seconds
    end
    ...
    def hash
      [payment_method, expiration_in_seconds].hash
    end
