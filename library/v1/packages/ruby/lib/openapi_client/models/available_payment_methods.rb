...
module OpenapiClient
  class AvailablePaymentMethods
    ...
    BankSlip = "BankSlip".freeze
    Crypto = "Crypto".freeze
    ApplePay = "ApplePay".freeze
    NuPay = "NuPay".freeze
    PicPay = "PicPay".freeze
    AmazonPay = "AmazonPay".freeze
    SepaDebit = "SepaDebit".freeze
    GooglePay = "GooglePay".freeze
    Draft = "Draft".freeze

    def self.all_vars
      @all_vars ||= [Pix, CreditCard, DebitCard, BankSlip, Crypto, ApplePay, NuPay, PicPay, AmazonPay, SepaDebit, GooglePay, Draft].freeze
    end
    ...
    def build_from_hash(value)
      return value if AvailablePaymentMethods.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AvailablePaymentMethods"
    end
  end
end
