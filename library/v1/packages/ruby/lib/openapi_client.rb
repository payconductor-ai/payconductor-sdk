...
require 'openapi_client/models/draft'
require 'openapi_client/models/draft_available_payment_methods_inner'
require 'openapi_client/models/draft_expiration_in_seconds'
...
require 'openapi_client/models/post_orders_by_id_confirm200_response'
...
require 'openapi_client/api/transfers_api'
