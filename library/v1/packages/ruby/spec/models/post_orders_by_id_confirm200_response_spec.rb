...
# Unit tests for OpenapiClient::PostOrdersByIdConfirm200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostOrdersByIdConfirm200Response do
  #let(:instance) { OpenapiClient::PostOrdersByIdConfirm200Response.new }

  describe 'test an instance of PostOrdersByIdConfirm200Response' do
    it 'should create an instance of PostOrdersByIdConfirm200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostOrdersByIdConfirm200Response)
    end
  end
