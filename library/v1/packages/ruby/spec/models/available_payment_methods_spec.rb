...
# Unit tests for OpenapiClient::AvailablePaymentMethods
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AvailablePaymentMethods do
  #let(:instance) { OpenapiClient::AvailablePaymentMethods.new }

  describe 'test an instance of AvailablePaymentMethods' do
    it 'should create an instance of AvailablePaymentMethods' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AvailablePaymentMethods)
    end
  end
