...
# Unit tests for OpenapiClient::PostWithdraws200ResponsePayoutAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostWithdraws200ResponsePayoutAccount do
  #let(:instance) { OpenapiClient::PostWithdraws200ResponsePayoutAccount.new }

  describe 'test an instance of PostWithdraws200ResponsePayoutAccount' do
    it 'should create an instance of PostWithdraws200ResponsePayoutAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostWithdraws200ResponsePayoutAccount)
    end
  end
  ...
  describe 'test attribute "owner_document"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "pix_key"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
