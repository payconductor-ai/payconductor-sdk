...
# Unit tests for OpenapiClient::PostWithdrawsRequestPayoutAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostWithdrawsRequestPayoutAccount do
  #let(:instance) { OpenapiClient::PostWithdrawsRequestPayoutAccount.new }

  describe 'test an instance of PostWithdrawsRequestPayoutAccount' do
    it 'should create an instance of PostWithdrawsRequestPayoutAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostWithdrawsRequestPayoutAccount)
    end
  end
