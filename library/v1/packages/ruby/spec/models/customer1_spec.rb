...
# Unit tests for OpenapiClient::Customer1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Customer1 do
  #let(:instance) { OpenapiClient::Customer1.new }

  describe 'test an instance of Customer1' do
    it 'should create an instance of Customer1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Customer1)
    end
  end
