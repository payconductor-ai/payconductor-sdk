...
# Unit tests for OpenapiClient::Draft
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Draft do
  #let(:instance) { OpenapiClient::Draft.new }

  describe 'test an instance of Draft' do
    it 'should create an instance of Draft' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Draft)
    end
  end
  ...
  describe 'test attribute "expiration_in_seconds"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
