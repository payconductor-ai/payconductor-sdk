...
# Unit tests for OpenapiClient::PixType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PixType do
  #let(:instance) { OpenapiClient::PixType.new }

  describe 'test an instance of PixType' do
    it 'should create an instance of PixType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PixType)
    end
  end
