...
# Unit tests for OpenapiClient::PostWithdraws200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostWithdraws200Response do
  #let(:instance) { OpenapiClient::PostWithdraws200Response.new }

  describe 'test an instance of PostWithdraws200Response' do
    it 'should create an instance of PostWithdraws200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostWithdraws200Response)
    end
  end
  ...
  describe 'test attribute "payout_account"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
