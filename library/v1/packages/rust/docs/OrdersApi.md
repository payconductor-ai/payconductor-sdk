...
> get_orders(page, page_size, end_date, start_date, id, status)
List orders
...
> models::PostOrdersByIdConfirm200Response post_orders_by_id_confirm(id, post_orders_request_payment)
Confirm order
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** |  | [required] |
**post_orders_request_payment** | [**PostOrdersRequestPayment**](PostOrdersRequestPayment.md) | Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...) | [required] |

### Return type

[**models::PostOrdersByIdConfirm200Response**](postOrdersByIdConfirm_200_response.md)
