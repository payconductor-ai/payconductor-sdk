...
pub async fn get_withdraws(configuration: &configuration::Configuration, page: f64, page_size: f64, end_date: Option<String>, start_date: Option<String>, id: Option<&str>) -> Result<(), Error<GetWithdrawsError>> {
