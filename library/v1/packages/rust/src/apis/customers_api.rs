...
pub async fn get_customers(configuration: &configuration::Configuration, page: f64, page_size: f64, email: Option<&str>, name: Option<&str>, end_date: Option<String>, start_date: Option<String>) -> Result<(), Error<GetCustomersError>> {
