...
namespace payconductor_sdk.Api
{
    ...
    public interface ICustomersApi : IApi
    {
        ...
        Task<IGetCustomersApiResponse> GetCustomersAsync(decimal page, decimal pageSize, Option<string> email = default, Option<string> name = default, Option<DateTime> endDate = default, Option<DateTime> startDate = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCustomersApiResponse"/>?&gt;</returns>
        Task<IGetCustomersApiResponse?> GetCustomersOrDefaultAsync(decimal page, decimal pageSize, Option<string> email = default, Option<string> name = default, Option<DateTime> endDate = default, Option<DateTime> startDate = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    public sealed partial class CustomersApi : ICustomersApi
    {
        ...
        partial void FormatGetCustomers(ref decimal page, ref decimal pageSize, ref Option<string> email, ref Option<string> name, ref Option<DateTime> endDate, ref Option<DateTime> startDate);
        ...
        /// <returns></returns>
        private void ValidateGetCustomers(Option<string> email, Option<string> name)
        {
        ...
        private void AfterGetCustomersDefaultImplementation(IGetCustomersApiResponse apiResponseLocalVar, decimal page, decimal pageSize, Option<string> email, Option<string> name, Option<DateTime> endDate, Option<DateTime> startDate)
        {
            bool suppressDefaultLog = false;
            AfterGetCustomers(ref suppressDefaultLog, apiResponseLocalVar, page, pageSize, email, name, endDate, startDate);
        ...
        /// <param name="endDate"></param>
        /// <param name="startDate"></param>
        partial void AfterGetCustomers(ref bool suppressDefaultLog, IGetCustomersApiResponse apiResponseLocalVar, decimal page, decimal pageSize, Option<string> email, Option<string> name, Option<DateTime> endDate, Option<DateTime> startDate);
        ...
        /// <param name="endDate"></param>
        /// <param name="startDate"></param>
        private void OnErrorGetCustomersDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, decimal page, decimal pageSize, Option<string> email, Option<string> name, Option<DateTime> endDate, Option<DateTime> startDate)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetCustomers(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, page, pageSize, email, name, endDate, startDate);
        ...
        /// <param name="endDate"></param>
        /// <param name="startDate"></param>
        partial void OnErrorGetCustomers(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, decimal page, decimal pageSize, Option<string> email, Option<string> name, Option<DateTime> endDate, Option<DateTime> startDate);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCustomersApiResponse"/>&gt;</returns>
        public async Task<IGetCustomersApiResponse?> GetCustomersOrDefaultAsync(decimal page, decimal pageSize, Option<string> email = default, Option<string> name = default, Option<DateTime> endDate = default, Option<DateTime> startDate = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetCustomersAsync(page, pageSize, email, name, endDate, startDate, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCustomersApiResponse"/>&gt;</returns>
        public async Task<IGetCustomersApiResponse> GetCustomersAsync(decimal page, decimal pageSize, Option<string> email = default, Option<string> name = default, Option<DateTime> endDate = default, Option<DateTime> startDate = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetCustomers(email, name);

                FormatGetCustomers(ref page, ref pageSize, ref email, ref name, ref endDate, ref startDate);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetCustomersDefaultImplementation(apiResponseLocalVar, page, pageSize, email, name, endDate, startDate);
            ...
            {
                OnErrorGetCustomersDefaultImplementation(e, "/customers/", uriBuilderLocalVar.Path, page, pageSize, email, name, endDate, startDate);
