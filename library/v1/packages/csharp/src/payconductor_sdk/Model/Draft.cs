...
namespace payconductor_sdk.Model
{
    ...
    public partial class Draft : IValidatableObject
    {
        ...
        public Option<DraftExpirationInSeconds?> ExpirationInSecondsOption { get; private set; }

        /// <summary>
        /// Gets or Sets ExpirationInSeconds
        /// </summary>
        [JsonPropertyName("expirationInSeconds")]
        public DraftExpirationInSeconds? ExpirationInSeconds { get { return this.ExpirationInSecondsOption; } set { this.ExpirationInSecondsOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Draft" />
    /// </summary>
    public class DraftJsonConverter : JsonConverter<Draft>
    {
        /// <summary>
        /// Deserializes json to <see cref="Draft" />
        /// </summary>
        ...
        public override Draft Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!paymentMethod.IsSet)
                throw new ArgumentException("Property is required for class Draft.", nameof(paymentMethod));

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class Draft.");

            if (expirationInSeconds.IsSet && expirationInSeconds.Value == null)
                throw new ArgumentNullException(nameof(expirationInSeconds), "Property is not nullable for class Draft.");
        ...
        /// <summary>
        /// Serializes a <see cref="Draft" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draft"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Draft draft, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, draft, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Draft" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draft"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, Draft draft, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (draft.ExpirationInSecondsOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, draft.ExpirationInSeconds, jsonSerializerOptions);
            }
            if (draft.AvailablePaymentMethodsOption.IsSet)
            {
                writer.WritePropertyName("availablePaymentMethods");
                JsonSerializer.Serialize(writer, draft.AvailablePaymentMethods, jsonSerializerOptions);
            }
        }
    }
}
