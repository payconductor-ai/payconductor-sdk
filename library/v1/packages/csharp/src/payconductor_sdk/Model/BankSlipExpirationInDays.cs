...
namespace payconductor_sdk.Model
{
    ...
    /// </summary>
    public partial class BankSlipExpirationInDays : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankSlipExpirationInDays" /> class.
        /// </summary>
        /// <param name="int"></param>
        /// <param name="int1"></param>
        internal BankSlipExpirationInDays(Option<int?> @int, Option<int?> int1)
        {
            IntOption = @int;
            Int1Option = int1;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BankSlipExpirationInDays {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="BankSlipExpirationInDays" />
    /// </summary>
    public class BankSlipExpirationInDaysJsonConverter : JsonConverter<BankSlipExpirationInDays>
    {
        /// <summary>
        /// Deserializes json to <see cref="BankSlipExpirationInDays" />
        /// </summary>
        ...
        public override BankSlipExpirationInDays Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new BankSlipExpirationInDays(varIntParsedValue, int1ParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="BankSlipExpirationInDays" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankSlipExpirationInDays"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BankSlipExpirationInDays bankSlipExpirationInDays, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (bankSlipExpirationInDays.IntOption.IsSet && bankSlipExpirationInDays.IntOption.Value != null)
                writer.WriteString("expirationInSeconds", bankSlipExpirationInDays.IntOption.Value);

            if (bankSlipExpirationInDays.Int1Option.IsSet && bankSlipExpirationInDays.Int1Option.Value != null)
                writer.WriteNumber("expirationInDays", bankSlipExpirationInDays.Int1Option.Value.Value);

            WriteProperties(writer, bankSlipExpirationInDays, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BankSlipExpirationInDays" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankSlipExpirationInDays"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BankSlipExpirationInDays bankSlipExpirationInDays, JsonSerializerOptions jsonSerializerOptions)
        {
