...
namespace payconductor_sdk.Model
{
    ...
    /// </summary>
    public partial class DraftExpirationInSeconds : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DraftExpirationInSeconds" /> class.
        /// </summary>
        /// <param name="int"></param>
        /// <param name="int1"></param>
        internal DraftExpirationInSeconds(Option<int?> @int, Option<int?> int1)
        {
            IntOption = @int;
            Int1Option = int1;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DraftExpirationInSeconds {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="DraftExpirationInSeconds" />
    /// </summary>
    public class DraftExpirationInSecondsJsonConverter : JsonConverter<DraftExpirationInSeconds>
    {
        /// <summary>
        /// Deserializes json to <see cref="DraftExpirationInSeconds" />
        /// </summary>
        ...
        public override DraftExpirationInSeconds Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DraftExpirationInSeconds(varIntParsedValue, int1ParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="DraftExpirationInSeconds" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draftExpirationInSeconds"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DraftExpirationInSeconds draftExpirationInSeconds, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (draftExpirationInSeconds.IntOption.IsSet && draftExpirationInSeconds.IntOption.Value != null)
                writer.WriteString("expirationInSeconds", draftExpirationInSeconds.IntOption.Value);

            if (draftExpirationInSeconds.Int1Option.IsSet && draftExpirationInSeconds.Int1Option.Value != null)
                writer.WriteNumber("expirationInSeconds", draftExpirationInSeconds.Int1Option.Value.Value);

            WriteProperties(writer, draftExpirationInSeconds, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DraftExpirationInSeconds" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draftExpirationInSeconds"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DraftExpirationInSeconds draftExpirationInSeconds, JsonSerializerOptions jsonSerializerOptions)
        {
