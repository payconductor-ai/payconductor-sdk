...
namespace payconductor_sdk.Model
{
    ...
    /// </summary>
    public partial class PixExpirationInSeconds : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PixExpirationInSeconds" /> class.
        /// </summary>
        /// <param name="int"></param>
        /// <param name="int1"></param>
        internal PixExpirationInSeconds(Option<int?> @int, Option<int?> int1)
        {
            IntOption = @int;
            Int1Option = int1;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PixExpirationInSeconds {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="PixExpirationInSeconds" />
    /// </summary>
    public class PixExpirationInSecondsJsonConverter : JsonConverter<PixExpirationInSeconds>
    {
        /// <summary>
        /// Deserializes json to <see cref="PixExpirationInSeconds" />
        /// </summary>
        ...
        public override PixExpirationInSeconds Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PixExpirationInSeconds(varIntParsedValue, int1ParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="PixExpirationInSeconds" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="pixExpirationInSeconds"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PixExpirationInSeconds pixExpirationInSeconds, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (pixExpirationInSeconds.IntOption.IsSet && pixExpirationInSeconds.IntOption.Value != null)
                writer.WriteString("expirationInSeconds", pixExpirationInSeconds.IntOption.Value);

            if (pixExpirationInSeconds.Int1Option.IsSet && pixExpirationInSeconds.Int1Option.Value != null)
                writer.WriteNumber("expirationInSeconds", pixExpirationInSeconds.Int1Option.Value.Value);

            WriteProperties(writer, pixExpirationInSeconds, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PixExpirationInSeconds" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="pixExpirationInSeconds"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PixExpirationInSeconds pixExpirationInSeconds, JsonSerializerOptions jsonSerializerOptions)
        {
