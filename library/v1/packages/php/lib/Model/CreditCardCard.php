...
/**
 * CreditCardCard Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreditCardCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'first_six_card_number' => 'string',
        'token' => 'string',
        'cvv' => 'string',
        'expiration' => '\OpenAPI\Client\Model\CompleteCardDataExpiration',
        'holder_name' => 'string',
        'number' => 'string'
    ];
    ...
    protected static $attributeMap = [
        'first_six_card_number' => 'firstSixCardNumber',
        'token' => 'token',
        'cvv' => 'cvv',
    ...
    protected static $setters = [
        'first_six_card_number' => 'setFirstSixCardNumber',
        'token' => 'setToken',
        'cvv' => 'setCvv',
    ...
    protected static $getters = [
        'first_six_card_number' => 'getFirstSixCardNumber',
        'token' => 'getToken',
        'cvv' => 'getCvv',
    ...
    {
        $this->setIfExists('first_six_card_number', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['cvv']) > 4)) {
    ...
    /**
     * Gets first_six_card_number
     *
     * @return string|null
     */
    public function getFirstSixCardNumber()
    {
        return $this->container['first_six_card_number'];
    }

    /**
     * Sets first_six_card_number
     *
     * @param string|null $first_six_card_number First 6 digits of the credit card
     *
     * @return self
     */
    public function setFirstSixCardNumber($first_six_card_number)
    {
        if (is_null($first_six_card_number)) {
            throw new \InvalidArgumentException('non-nullable first_six_card_number cannot be null');
        }
        $this->container['first_six_card_number'] = $first_six_card_number;
     ...
     * Sets token
     *
     * @param string $token Previously generated credit card token
     *
     * @return self
     */
    ...
    public function setCvv($cvv)
    {
        ...
        if ((mb_strlen($cvv) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling CreditCardCard., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($cvv) < 3)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling CreditCardCard., must be bigger than or equal to 3.');
        }
     ...
     * Gets expiration
     *
     * @return \OpenAPI\Client\Model\CompleteCardDataExpiration
     */
     ...
     * Sets expiration
     *
     * @param \OpenAPI\Client\Model\CompleteCardDataExpiration $expiration expiration
     *
     * @return self
     */
     ...
     * Sets holder_name
     *
     * @param string $holder_name Card holder name
     *
     * @return self
     */
