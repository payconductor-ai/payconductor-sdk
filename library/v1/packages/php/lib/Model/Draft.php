 ...
 *
 * @category Class
 * @description Used to create an order without generating a real payment. Use to create orders that will be paid later
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Draft implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\DraftExpirationInSeconds|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\DraftExpirationInSeconds|null $expiration_in_seconds expiration_in_seconds
     *
     * @return self
     */
