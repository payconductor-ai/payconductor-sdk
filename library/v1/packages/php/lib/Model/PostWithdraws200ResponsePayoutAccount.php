...
/**
 * PostWithdraws200ResponsePayoutAccount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostWithdraws200ResponsePayoutAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postWithdraws_200_response_payoutAccount';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^\\d{11}$|^\\d{14}$/", $this->container['owner_document'])) {
            $invalidProperties[] = "invalid value for 'owner_document', must be conform to the pattern /^\\d{11}$|^\\d{14}$/.";
        }
     ...
     * Sets id
     *
     * @param string $id Unique payment account identifier
     *
     * @return self
     */
    ...
    public function setOwnerDocument($owner_document)
    {
        ...
        if ((!preg_match("/^\\d{11}$|^\\d{14}$/", ObjectSerializer::toString($owner_document)))) {
            throw new \InvalidArgumentException("invalid value for \$owner_document when calling PostWithdraws200ResponsePayoutAccount., must conform to the pattern /^\\d{11}$|^\\d{14}$/.");
        }
     ...
     * Sets pix_key
     *
     * @param string $pix_key PIX key used for the withdrawal
     *
     * @return self
     */
