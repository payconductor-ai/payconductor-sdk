...
*/
func (a *OrdersAPIService) GetOrdersById(ctx context.Context, id string) ApiGetOrdersByIdRequest {
	return ApiGetOrdersByIdRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *OrdersAPIService) GetOrdersByIdExecute(r ApiGetOrdersByIdRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrdersAPIService.GetOrdersById")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *OrdersAPIService) PostOrdersExecute(r ApiPostOrdersRequest) (*PostOrders200Response, *http.Response, error) {
	var (
...
type ApiPostOrdersByIdConfirmRequest struct {
	ctx context.Context
	ApiService *OrdersAPIService
	id string
	postOrdersRequestPayment *PostOrdersRequestPayment
}

// Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)
func (r ApiPostOrdersByIdConfirmRequest) PostOrdersRequestPayment(postOrdersRequestPayment PostOrdersRequestPayment) ApiPostOrdersByIdConfirmRequest {
	r.postOrdersRequestPayment = &postOrdersRequestPayment
	return r
}

func (r ApiPostOrdersByIdConfirmRequest) Execute() (*PostOrdersByIdConfirm200Response, *http.Response, error) {
	return r.ApiService.PostOrdersByIdConfirmExecute(r)
}

/*
PostOrdersByIdConfirm Confirm order

Confirms a Draft order, setting the payment method and processing the charges associated with the order.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiPostOrdersByIdConfirmRequest
*/
func (a *OrdersAPIService) PostOrdersByIdConfirm(ctx context.Context, id string) ApiPostOrdersByIdConfirmRequest {
	return ApiPostOrdersByIdConfirmRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *OrdersAPIService) PostOrdersByIdConfirmExecute(r ApiPostOrdersByIdConfirmRequest) (*PostOrdersByIdConfirm200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PostOrdersByIdConfirm200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrdersAPIService.PostOrdersByIdConfirm")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.postOrdersRequestPayment == nil {
		return localVarReturnValue, nil, reportError("postOrdersRequestPayment is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postOrdersRequestPayment
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
PostOrdersByIdRefund Refund order
...
*/
func (a *OrdersAPIService) PostOrdersByIdRefund(ctx context.Context, id string) ApiPostOrdersByIdRefundRequest {
	return ApiPostOrdersByIdRefundRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *OrdersAPIService) PostOrdersByIdRefundExecute(r ApiPostOrdersByIdRefundRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrdersAPIService.PostOrdersByIdRefund")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
