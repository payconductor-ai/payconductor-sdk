...
// DraftExpirationInSeconds Order expiration time in seconds
type DraftExpirationInSeconds struct {
	Int32 *int32
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *DraftExpirationInSeconds) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(DraftExpirationInSeconds)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DraftExpirationInSeconds) MarshalJSON() ([]byte, error) {
	if src.Int32 != nil {
...
type NullableDraftExpirationInSeconds struct {
	value *DraftExpirationInSeconds
	isSet bool
}

func (v NullableDraftExpirationInSeconds) Get() *DraftExpirationInSeconds {
	return v.value
}

func (v *NullableDraftExpirationInSeconds) Set(val *DraftExpirationInSeconds) {
	v.value = val
	v.isSet = true
}

func (v NullableDraftExpirationInSeconds) IsSet() bool {
	return v.isSet
}

func (v *NullableDraftExpirationInSeconds) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDraftExpirationInSeconds(val *DraftExpirationInSeconds) *NullableDraftExpirationInSeconds {
	return &NullableDraftExpirationInSeconds{value: val, isSet: true}
}

func (v NullableDraftExpirationInSeconds) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDraftExpirationInSeconds) UnmarshalJSON(src []byte) error {
	v.isSet = true
