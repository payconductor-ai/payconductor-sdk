...
// CreditCardInstallments Number of installments
type CreditCardInstallments struct {
	Int32 *int32
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *CreditCardInstallments) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(CreditCardInstallments)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src CreditCardInstallments) MarshalJSON() ([]byte, error) {
	if src.Int32 != nil {
...
type NullableCreditCardInstallments struct {
	value *CreditCardInstallments
	isSet bool
}

func (v NullableCreditCardInstallments) Get() *CreditCardInstallments {
	return v.value
}

func (v *NullableCreditCardInstallments) Set(val *CreditCardInstallments) {
	v.value = val
	v.isSet = true
}

func (v NullableCreditCardInstallments) IsSet() bool {
	return v.isSet
}

func (v *NullableCreditCardInstallments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreditCardInstallments(val *CreditCardInstallments) *NullableCreditCardInstallments {
	return &NullableCreditCardInstallments{value: val, isSet: true}
}

func (v NullableCreditCardInstallments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreditCardInstallments) UnmarshalJSON(src []byte) error {
	v.isSet = true
