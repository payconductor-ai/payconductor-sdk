...
// DraftAvailablePaymentMethodsInner struct for DraftAvailablePaymentMethodsInner
type DraftAvailablePaymentMethodsInner struct {
	String *string
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *DraftAvailablePaymentMethodsInner) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(DraftAvailablePaymentMethodsInner)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DraftAvailablePaymentMethodsInner) MarshalJSON() ([]byte, error) {
	if src.String != nil {
...
type NullableDraftAvailablePaymentMethodsInner struct {
	value *DraftAvailablePaymentMethodsInner
	isSet bool
}

func (v NullableDraftAvailablePaymentMethodsInner) Get() *DraftAvailablePaymentMethodsInner {
	return v.value
}

func (v *NullableDraftAvailablePaymentMethodsInner) Set(val *DraftAvailablePaymentMethodsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDraftAvailablePaymentMethodsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDraftAvailablePaymentMethodsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDraftAvailablePaymentMethodsInner(val *DraftAvailablePaymentMethodsInner) *NullableDraftAvailablePaymentMethodsInner {
	return &NullableDraftAvailablePaymentMethodsInner{value: val, isSet: true}
}

func (v NullableDraftAvailablePaymentMethodsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDraftAvailablePaymentMethodsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
