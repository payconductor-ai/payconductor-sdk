...
#
package WWW::OpenAPIClient::Object::PostOrdersRequestPayment;
...
__PACKAGE__->class_documentation({description => 'Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)',
...
__PACKAGE__->method_documentation({
    ...
    'expiration_in_seconds' => {
        datatype => 'DraftExpirationInSeconds',
        base_name => 'expirationInSeconds',
        description => '',
        format => '',
        read_only => '',
            },
    'card' => {
        datatype => 'CreditCardCard',
        base_name => 'card',
        description => '',
        format => '',
        read_only => '',
    ...
    'installments' => {
        datatype => 'CreditCardInstallments',
    ...
    'soft_descriptor' => {
        datatype => 'string',
        base_name => 'softDescriptor',
        description => 'Text that will appear on the card statement (soft descriptor)',
        format => '',
        read_only => '',
            },
    'expiration_in_days' => {
        datatype => 'BankSlipExpirationInDays',
        base_name => 'expirationInDays',
        description => '',
        format => '',
        read_only => '',
            },
