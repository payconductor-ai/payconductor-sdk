...
#
package WWW::OpenAPIClient::Object::DraftExpirationInSeconds;
...
__PACKAGE__->class_documentation({description => 'Order expiration time in seconds',
                                  class => 'DraftExpirationInSeconds',
                                  required => [], # TODO
}                                 );
