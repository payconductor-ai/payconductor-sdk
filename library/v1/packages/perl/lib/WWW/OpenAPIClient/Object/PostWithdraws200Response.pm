...
#
package WWW::OpenAPIClient::Object::PostWithdraws200Response;
...
__PACKAGE__->method_documentation({
    ...
    'payed_at' => {
        datatype => 'PostWithdraws200ResponsePayedAt',
        base_name => 'payedAt',
        description => '',
        format => '',
        read_only => '',
    ...
    'payout_account' => {
        datatype => 'PostWithdraws200ResponsePayoutAccount',
        base_name => 'payoutAccount',
        description => '',
        format => '',
        read_only => '',
            },
