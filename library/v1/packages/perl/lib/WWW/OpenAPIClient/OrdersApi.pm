...
#
# @param string $id  (required)
# @param PostOrdersRequestPayment $post_orders_request_payment Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...) (required)
{
    my $params = {
    'id' => {
        data_type => 'string',
    ...
    'post_orders_request_payment' => {
        data_type => 'PostOrdersRequestPayment',
        description => 'Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'post_orders_by_id_confirm' } = {
        summary => 'Confirm order',
        params => $params,
        returns => 'PostOrdersByIdConfirm200Response',
        };
}
# @return PostOrdersByIdConfirm200Response
#
sub post_orders_by_id_confirm {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling post_orders_by_id_confirm");
    }

    # verify the required parameter 'post_orders_request_payment' is set
    unless (exists $args{'post_orders_request_payment'}) {
      croak("Missing the required parameter 'post_orders_request_payment' when calling post_orders_by_id_confirm");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'post_orders_request_payment'}) {
        $_body_data = $args{'post_orders_request_payment'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('PostOrdersByIdConfirm200Response', $response);
    return $_response_object;
}
