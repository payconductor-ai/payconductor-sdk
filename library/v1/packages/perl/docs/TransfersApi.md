# WWW::OpenAPIClient::TransfersApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::TransfersApi;
```
...
# **get_withdraws**
> get_withdraws(page => $page, page_size => $page_size, end_date => $end_date, start_date => $start_date, id => $id)
...
eval {
    $api_instance->get_withdraws(page => $page, page_size => $page_size, end_date => $end_date, start_date => $start_date, id => $id);
};
if ($@) {
    warn "Exception when calling TransfersApi->get_withdraws: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling TransfersApi->get_withdraws_by_id: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling TransfersApi->post_withdraws: $@\n";
}
```
