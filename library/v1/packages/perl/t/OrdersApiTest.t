...
#my $get_orders_result = $api->get_orders(page => $get_orders_page, page_size => $get_orders_page_size, end_date => $get_orders_end_date, start_date => $get_orders_start_date, id => $get_orders_id, status => $get_orders_status);
...
#
# post_orders_by_id_confirm test
#
# uncomment below and update the test
#my $post_orders_by_id_confirm_id = undef; # replace NULL with a proper value
#my $post_orders_by_id_confirm_post_orders_request_payment = undef; # replace NULL with a proper value
#my $post_orders_by_id_confirm_result = $api->post_orders_by_id_confirm(id => $post_orders_by_id_confirm_id, post_orders_request_payment => $post_orders_by_id_confirm_post_orders_request_payment);
