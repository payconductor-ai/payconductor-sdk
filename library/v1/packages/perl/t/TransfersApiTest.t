...
use_ok('WWW::OpenAPIClient::TransfersApi');

my $api = WWW::OpenAPIClient::TransfersApi->new();
isa_ok($api, 'WWW::OpenAPIClient::TransfersApi');
...
#my $get_withdraws_result = $api->get_withdraws(page => $get_withdraws_page, page_size => $get_withdraws_page_size, end_date => $get_withdraws_end_date, start_date => $get_withdraws_start_date, id => $get_withdraws_id);
