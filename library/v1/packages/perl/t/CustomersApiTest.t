...
#my $get_customers_result = $api->get_customers(page => $get_customers_page, page_size => $get_customers_page_size, email => $get_customers_email, name => $get_customers_name, end_date => $get_customers_end_date, start_date => $get_customers_start_date);
