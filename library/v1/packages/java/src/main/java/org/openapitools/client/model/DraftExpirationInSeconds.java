...
public class DraftExpirationInSeconds extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DraftExpirationInSeconds.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DraftExpirationInSeconds.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DraftExpirationInSeconds' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Integer> adapterInteger = gson.getDelegateAdapter(this, TypeToken.get(Integer.class));

            return (TypeAdapter<T>) new TypeAdapter<DraftExpirationInSeconds>() {
                @Override
                public void write(JsonWriter out, DraftExpirationInSeconds value) throws IOException {
                ...
                @Override
                public DraftExpirationInSeconds read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DraftExpirationInSeconds ret = new DraftExpirationInSeconds();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DraftExpirationInSeconds: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DraftExpirationInSeconds() {
        super("anyOf", Boolean.FALSE);
    }

    public DraftExpirationInSeconds(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DraftExpirationInSeconds.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DraftExpirationInSeconds
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DraftExpirationInSeconds with anyOf schemas: Integer. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DraftExpirationInSeconds given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DraftExpirationInSeconds
     * @throws IOException if the JSON string is invalid with respect to DraftExpirationInSeconds
     */
    public static DraftExpirationInSeconds fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DraftExpirationInSeconds.class);
    }

    /**
     * Convert an instance of DraftExpirationInSeconds to an JSON string
     *
     * @return JSON string
     */
