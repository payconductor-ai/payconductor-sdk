 ...
 */
@JsonAdapter(PixType.Adapter.class)
public enum PixType {
  ...
  public static PixType fromValue(String value) {
    for (PixType b : PixType.values()) {
  ...
  public static class Adapter extends TypeAdapter<PixType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PixType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PixType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PixType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PixType.fromValue(value);
  }
}
