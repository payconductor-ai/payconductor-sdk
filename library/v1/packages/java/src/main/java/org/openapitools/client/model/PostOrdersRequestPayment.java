...
public class PostOrdersRequestPayment extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Draft> adapterDraft = gson.getDelegateAdapter(this, TypeToken.get(Draft.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<PostOrdersRequestPayment>() {
                ...
                public void write(JsonWriter out, PostOrdersRequestPayment value) throws IOException {
                    ...
                    // check if the actual instance is of the type `Draft`
                    if (value.getActualInstance() instanceof Draft) {
                        JsonElement element = adapterDraft.toJsonTree((Draft)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BankSlip, CreditCard, Draft, NuPay, PicPay, Pix");
    }
     ...
     * BankSlip, CreditCard, Draft, NuPay, PicPay, Pix
     *
     * @return The actual instance (BankSlip, CreditCard, Draft, NuPay, PicPay, Pix)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `Draft`. If the actual instance is not `Draft`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Draft`
     * @throws ClassCastException if the instance is not `Draft`
     */
    public Draft getDraft() throws ClassCastException {
        return (Draft)super.getActualInstance();
    }
