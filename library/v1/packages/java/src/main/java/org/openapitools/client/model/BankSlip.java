...
public class BankSlip {
  ...
  private BankSlipExpirationInDays expirationInDays = 7;
  ...
  public BankSlip expirationInDays(@javax.annotation.Nullable BankSlipExpirationInDays expirationInDays) {
   ...
   */
  @javax.annotation.Nullable
  public BankSlipExpirationInDays getExpirationInDays() {
    return expirationInDays;
  }

  public void setExpirationInDays(@javax.annotation.Nullable BankSlipExpirationInDays expirationInDays) {
    this.expirationInDays = expirationInDays;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.paymentMethod, bankSlip.paymentMethod) &&
        Objects.equals(this.expirationInDays, bankSlip.expirationInDays);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BankSlip
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BankSlip.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BankSlip is not found in the empty JSON string", BankSlip.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BankSlip.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BankSlip` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankSlip.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankSlip.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankSlip' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankSlip> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankSlip.class));

       return (TypeAdapter<T>) new TypeAdapter<BankSlip>() {
           @Override
           public void write(JsonWriter out, BankSlip value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BankSlip read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BankSlip given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BankSlip
   * @throws IOException if the JSON string is invalid with respect to BankSlip
   */
  public static BankSlip fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankSlip.class);
  }

  /**
   * Convert an instance of BankSlip to an JSON string
   *
   * @return JSON string
   */
