...
public class Pix {
  ...
  private PixExpirationInSeconds expirationInSeconds = 3600;

  public Pix() {
  }

  public Pix paymentMethod(@javax.annotation.Nonnull PaymentMethod paymentMethod) {
  ...
  public Pix expirationInSeconds(@javax.annotation.Nullable PixExpirationInSeconds expirationInSeconds) {
   ...
   */
  @javax.annotation.Nullable
  public PixExpirationInSeconds getExpirationInSeconds() {
    return expirationInSeconds;
  }

  public void setExpirationInSeconds(@javax.annotation.Nullable PixExpirationInSeconds expirationInSeconds) {
    this.expirationInSeconds = expirationInSeconds;
  }
  ...
  public boolean equals(Object o) {
    ...
    Pix pix = (Pix) o;
    return Objects.equals(this.paymentMethod, pix.paymentMethod) &&
        Objects.equals(this.expirationInSeconds, pix.expirationInSeconds);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("expirationInSeconds") != null && !jsonObj.get("expirationInSeconds").isJsonNull()) {
        PixExpirationInSeconds.validateJsonElement(jsonObj.get("expirationInSeconds"));
      }
  }
