...
public class MerchantInput {
  ...
  public MerchantInput document(@javax.annotation.Nonnull String document) {
  ...
  public MerchantInput email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public MerchantInput name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MerchantInput merchantInput = (MerchantInput) o;
    return Objects.equals(this.document, merchantInput.document) &&
        Objects.equals(this.email, merchantInput.email) &&
        Objects.equals(this.name, merchantInput.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(document, email, name);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("document", "email", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("document", "email", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MerchantInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MerchantInput is not found in the empty JSON string", MerchantInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MerchantInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MerchantInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantInput>() {
           @Override
           public void write(JsonWriter out, MerchantInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MerchantInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MerchantInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MerchantInput
   * @throws IOException if the JSON string is invalid with respect to MerchantInput
   */
  public static MerchantInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantInput.class);
  }

  /**
   * Convert an instance of MerchantInput to an JSON string
   *
   * @return JSON string
   */
