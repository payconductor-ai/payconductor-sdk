...
public class WithdrawCreateResponsePayedAt extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WithdrawCreateResponsePayedAt.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WithdrawCreateResponsePayedAt.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WithdrawCreateResponsePayedAt' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WithdrawCreateResponsePayedAt>() {
                @Override
                public void write(JsonWriter out, WithdrawCreateResponsePayedAt value) throws IOException {
                ...
                @Override
                public WithdrawCreateResponsePayedAt read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WithdrawCreateResponsePayedAt ret = new WithdrawCreateResponsePayedAt();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WithdrawCreateResponsePayedAt: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WithdrawCreateResponsePayedAt() {
        super("anyOf", Boolean.TRUE);
    }

    public WithdrawCreateResponsePayedAt(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return WithdrawCreateResponsePayedAt.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WithdrawCreateResponsePayedAt
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for WithdrawCreateResponsePayedAt with anyOf schemas: BigDecimal, Date, LocalDate, OffsetDateTime. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of WithdrawCreateResponsePayedAt given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WithdrawCreateResponsePayedAt
     * @throws IOException if the JSON string is invalid with respect to WithdrawCreateResponsePayedAt
     */
    public static WithdrawCreateResponsePayedAt fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WithdrawCreateResponsePayedAt.class);
    }

    /**
     * Convert an instance of WithdrawCreateResponsePayedAt to an JSON string
     *
     * @return JSON string
     */
