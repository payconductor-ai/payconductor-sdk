...
public class CreditCardInstallments extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreditCardInstallments.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreditCardInstallments.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreditCardInstallments' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Integer> adapterInteger = gson.getDelegateAdapter(this, TypeToken.get(Integer.class));

            return (TypeAdapter<T>) new TypeAdapter<CreditCardInstallments>() {
                @Override
                public void write(JsonWriter out, CreditCardInstallments value) throws IOException {
                ...
                @Override
                public CreditCardInstallments read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CreditCardInstallments ret = new CreditCardInstallments();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreditCardInstallments: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreditCardInstallments(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CreditCardInstallments.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CreditCardInstallments
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CreditCardInstallments with anyOf schemas: Integer. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CreditCardInstallments given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CreditCardInstallments
     * @throws IOException if the JSON string is invalid with respect to CreditCardInstallments
     */
    public static CreditCardInstallments fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CreditCardInstallments.class);
    }

    /**
     * Convert an instance of CreditCardInstallments to an JSON string
     *
     * @return JSON string
     */
