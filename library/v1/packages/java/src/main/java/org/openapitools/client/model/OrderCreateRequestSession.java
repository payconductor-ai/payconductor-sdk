...
public class OrderCreateRequestSession {
  ...
  public OrderCreateRequestSession() {
  }

  public OrderCreateRequestSession expiresInMinutes(@javax.annotation.Nullable BigDecimal expiresInMinutes) {
  ...
  public OrderCreateRequestSession checkoutUrl(@javax.annotation.Nullable String checkoutUrl) {
  ...
  public OrderCreateRequestSession sessionId(@javax.annotation.Nullable String sessionId) {
  ...
  public OrderCreateRequestSession externalSessionId(@javax.annotation.Nullable String externalSessionId) {
  ...
  public boolean equals(Object o) {
    ...
    OrderCreateRequestSession orderCreateRequestSession = (OrderCreateRequestSession) o;
    return Objects.equals(this.expiresInMinutes, orderCreateRequestSession.expiresInMinutes) &&
        Objects.equals(this.checkoutUrl, orderCreateRequestSession.checkoutUrl) &&
        Objects.equals(this.sessionId, orderCreateRequestSession.sessionId) &&
        Objects.equals(this.externalSessionId, orderCreateRequestSession.externalSessionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderCreateRequestSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderCreateRequestSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderCreateRequestSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrderCreateRequestSession is not found in the empty JSON string", OrderCreateRequestSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderCreateRequestSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderCreateRequestSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderCreateRequestSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderCreateRequestSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderCreateRequestSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderCreateRequestSession.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderCreateRequestSession>() {
           @Override
           public void write(JsonWriter out, OrderCreateRequestSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderCreateRequestSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderCreateRequestSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderCreateRequestSession
   * @throws IOException if the JSON string is invalid with respect to OrderCreateRequestSession
   */
  public static OrderCreateRequestSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderCreateRequestSession.class);
  }

  /**
   * Convert an instance of OrderCreateRequestSession to an JSON string
   *
   * @return JSON string
   */
