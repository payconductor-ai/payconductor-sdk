 ...
 * Gets or Sets Event
 */
@JsonAdapter(Event.Adapter.class)
public enum Event {
  ...
  public static class Adapter extends TypeAdapter<Event> {
    @Override
    public void write(final JsonWriter jsonWriter, final Event enumeration) throws IOException {
