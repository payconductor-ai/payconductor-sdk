...
public class Draft {
  ...
  private DraftExpirationInSeconds expirationInSeconds = 3600;
  ...
  public Draft expirationInSeconds(@javax.annotation.Nullable DraftExpirationInSeconds expirationInSeconds) {
   ...
   */
  @javax.annotation.Nullable
  public DraftExpirationInSeconds getExpirationInSeconds() {
    return expirationInSeconds;
  }

  public void setExpirationInSeconds(@javax.annotation.Nullable DraftExpirationInSeconds expirationInSeconds) {
    this.expirationInSeconds = expirationInSeconds;
  }
  ...
  public boolean equals(Object o) {
    ...
    Draft draft = (Draft) o;
    return Objects.equals(this.paymentMethod, draft.paymentMethod) &&
        Objects.equals(this.expirationInSeconds, draft.expirationInSeconds) &&
        Objects.equals(this.availablePaymentMethods, draft.availablePaymentMethods);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Draft.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Draft is not found in the empty JSON string", Draft.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Draft.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Draft` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Draft.openapiRequiredFields) {
