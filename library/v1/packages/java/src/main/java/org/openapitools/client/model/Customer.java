...
public class Customer {
  ...
  public Customer address(@javax.annotation.Nullable CustomerAddress address) {
  ...
  public Customer documentNumber(@javax.annotation.Nonnull String documentNumber) {
  ...
  public Customer phoneNumber(@javax.annotation.Nullable String phoneNumber) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, customer.address) &&
        Objects.equals(this.documentNumber, customer.documentNumber) &&
        Objects.equals(this.documentType, customer.documentType) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Customer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Customer is not found in the empty JSON string", Customer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Customer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Customer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
