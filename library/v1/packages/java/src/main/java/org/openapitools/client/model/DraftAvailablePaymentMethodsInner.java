...
public class DraftAvailablePaymentMethodsInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DraftAvailablePaymentMethodsInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DraftAvailablePaymentMethodsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DraftAvailablePaymentMethodsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<String> adapterString = gson.getDelegateAdapter(this, TypeToken.get(String.class));

            return (TypeAdapter<T>) new TypeAdapter<DraftAvailablePaymentMethodsInner>() {
                @Override
                public void write(JsonWriter out, DraftAvailablePaymentMethodsInner value) throws IOException {
                ...
                @Override
                public DraftAvailablePaymentMethodsInner read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DraftAvailablePaymentMethodsInner ret = new DraftAvailablePaymentMethodsInner();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DraftAvailablePaymentMethodsInner: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DraftAvailablePaymentMethodsInner() {
        super("anyOf", Boolean.FALSE);
    }

    public DraftAvailablePaymentMethodsInner(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DraftAvailablePaymentMethodsInner.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DraftAvailablePaymentMethodsInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DraftAvailablePaymentMethodsInner with anyOf schemas: String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DraftAvailablePaymentMethodsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DraftAvailablePaymentMethodsInner
     * @throws IOException if the JSON string is invalid with respect to DraftAvailablePaymentMethodsInner
     */
    public static DraftAvailablePaymentMethodsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DraftAvailablePaymentMethodsInner.class);
    }

    /**
     * Convert an instance of DraftAvailablePaymentMethodsInner to an JSON string
     *
     * @return JSON string
     */
