 ...
 */
@JsonAdapter(AvailablePaymentMethods.Adapter.class)
public enum AvailablePaymentMethods {
  ...
  AvailablePaymentMethods(String value) {
    this.value = value;
  }
  ...
  public static AvailablePaymentMethods fromValue(String value) {
    for (AvailablePaymentMethods b : AvailablePaymentMethods.values()) {
  ...
  public static class Adapter extends TypeAdapter<AvailablePaymentMethods> {
    @Override
    public void write(final JsonWriter jsonWriter, final AvailablePaymentMethods enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AvailablePaymentMethods read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AvailablePaymentMethods.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AvailablePaymentMethods.fromValue(value);
  }
}
