...
public class NuPay {
  ...
  @javax.annotation.Nonnull
  private NuPayNuPay nuPay;

  public NuPay() {
  }

  public NuPay paymentMethod(@javax.annotation.Nonnull PaymentMethod paymentMethod) {
  ...
  public NuPay nuPay(@javax.annotation.Nonnull NuPayNuPay nuPay) {
    this.nuPay = nuPay;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public NuPayNuPay getNuPay() {
    return nuPay;
  }

  public void setNuPay(@javax.annotation.Nonnull NuPayNuPay nuPay) {
    this.nuPay = nuPay;
  }
  ...
  public boolean equals(Object o) {
    ...
    NuPay nuPay = (NuPay) o;
    return Objects.equals(this.paymentMethod, nuPay.paymentMethod) &&
        Objects.equals(this.nuPay, nuPay.nuPay);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NuPay
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NuPay.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NuPay is not found in the empty JSON string", NuPay.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NuPay.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `NuPay` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NuPay.openapiRequiredFields) {
      ...
      NuPayNuPay.validateJsonElement(jsonObj.get("nuPay"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NuPay.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NuPay' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NuPay> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NuPay.class));

       return (TypeAdapter<T>) new TypeAdapter<NuPay>() {
           @Override
           public void write(JsonWriter out, NuPay value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NuPay read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NuPay given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NuPay
   * @throws IOException if the JSON string is invalid with respect to NuPay
   */
  public static NuPay fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NuPay.class);
  }

  /**
   * Convert an instance of NuPay to an JSON string
   *
   * @return JSON string
   */
