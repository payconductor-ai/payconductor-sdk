...
(function(root, factory) {
  ...
  describe('PixType', function() {
    it('should create an instance of PixType', function() {
      // uncomment below and update the code to test PixType
      //var instance = new PayconductorSdk.PixType();
      //expect(instance).to.be.a(PayconductorSdk.PixType);
    });
