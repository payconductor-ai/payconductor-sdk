...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.DraftExpirationInSeconds();
  });
  ...
  describe('DraftExpirationInSeconds', function() {
    it('should create an instance of DraftExpirationInSeconds', function() {
      // uncomment below and update the code to test DraftExpirationInSeconds
      //var instance = new PayconductorSdk.DraftExpirationInSeconds();
      //expect(instance).to.be.a(PayconductorSdk.DraftExpirationInSeconds);
    });
