...
(function(root, factory) {
  ...
  describe('AvailablePaymentMethods', function() {
    it('should create an instance of AvailablePaymentMethods', function() {
      // uncomment below and update the code to test AvailablePaymentMethods
      //var instance = new PayconductorSdk.AvailablePaymentMethods();
      //expect(instance).to.be.a(PayconductorSdk.AvailablePaymentMethods);
    });
