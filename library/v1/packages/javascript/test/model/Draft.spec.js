...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.Draft();
  });
  ...
  describe('Draft', function() {
    it('should create an instance of Draft', function() {
      ...
      //var instance = new PayconductorSdk.Draft();
      //expect(instance).to.be.a(PayconductorSdk.Draft);
    });
    ...
    it('should have the property availablePaymentMethods (base name: "availablePaymentMethods")', function() {
