...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.DraftAvailablePaymentMethodsInner();
  });
  ...
  describe('DraftAvailablePaymentMethodsInner', function() {
    it('should create an instance of DraftAvailablePaymentMethodsInner', function() {
      // uncomment below and update the code to test DraftAvailablePaymentMethodsInner
      //var instance = new PayconductorSdk.DraftAvailablePaymentMethodsInner();
      //expect(instance).to.be.a(PayconductorSdk.DraftAvailablePaymentMethodsInner);
    });
