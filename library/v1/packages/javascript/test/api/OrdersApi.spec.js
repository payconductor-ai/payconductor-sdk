...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.OrdersApi();
  });
  ...
  describe('OrdersApi', function() {
    ...
    describe('postOrdersByIdConfirm', function() {
      it('should call postOrdersByIdConfirm successfully', function(done) {
        //uncomment below and update the code to test postOrdersByIdConfirm
        //instance.postOrdersByIdConfirm(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postOrdersByIdRefund', function() {
      it('should call postOrdersByIdRefund successfully', function(done) {
        //uncomment below and update the code to test postOrdersByIdRefund
        //instance.postOrdersByIdRefund(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
