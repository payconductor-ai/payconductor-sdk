...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.TransfersApi();
  });
  ...
  describe('TransfersApi', function() {
    describe('getWithdraws', function() {
      it('should call getWithdraws successfully', function(done) {
        //uncomment below and update the code to test getWithdraws
        //instance.getWithdraws(function(error) {
    ...
    describe('getWithdrawsById', function() {
      it('should call getWithdrawsById successfully', function(done) {
        //uncomment below and update the code to test getWithdrawsById
        //instance.getWithdrawsById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postWithdraws', function() {
      it('should call postWithdraws successfully', function(done) {
        //uncomment below and update the code to test postWithdraws
        //instance.postWithdraws(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
