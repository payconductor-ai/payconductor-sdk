...
class Pix {
    ...
    constructor(paymentMethod) { 
        ...
        Pix.initialize(this, paymentMethod);
    }
    ...
    /**
     * Constructs a <code>Pix</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Pix} obj Optional instance to populate.
     * @return {module:model/Pix} The populated <code>Pix</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Pix</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Pix</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Pix.RequiredProperties) {
...
/**
 * @member {module:model/PixExpirationInSeconds} expirationInSeconds
 */
Pix.prototype['expirationInSeconds'] = undefined;
