...
class BankSlip {
    ...
    constructor(paymentMethod) { 
        ...
        BankSlip.initialize(this, paymentMethod);
    }
    ...
    /**
     * Constructs a <code>BankSlip</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BankSlip} obj Optional instance to populate.
     * @return {module:model/BankSlip} The populated <code>BankSlip</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>BankSlip</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BankSlip</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BankSlip.RequiredProperties) {
 ...
 */
BankSlip.prototype['expirationInDays'] = undefined;
