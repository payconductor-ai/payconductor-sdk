...
export default class PixType {
    ...
    /**
    * Returns a <code>PixType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PixType} The enum <code>PixType</code> value.
    */
