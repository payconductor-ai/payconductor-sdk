...
export default class OrdersApi {
    ...
    */
     ...
     */
    getOrders(page, pageSize, opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the postOrdersByIdConfirm operation.
     * @callback module:api/OrdersApi~postOrdersByIdConfirmCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PostOrdersByIdConfirm200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id 
     * @param {module:model/PostOrdersRequestPayment} postOrdersRequestPayment Payment data for the order (Pix, Credit Card, Bank Slip, NuPay, etc...)
     * @param {module:api/OrdersApi~postOrdersByIdConfirmCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PostOrdersByIdConfirm200Response}
     */
    postOrdersByIdConfirm(id, postOrdersRequestPayment, callback) {
      let postBody = postOrdersRequestPayment;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling postOrdersByIdConfirm");
      }
      // verify the required parameter 'postOrdersRequestPayment' is set
      if (postOrdersRequestPayment === undefined || postOrdersRequestPayment === null) {
        throw new Error("Missing the required parameter 'postOrdersRequestPayment' when calling postOrdersByIdConfirm");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = PostOrdersByIdConfirm200Response;
      return this.apiClient.callApi(
