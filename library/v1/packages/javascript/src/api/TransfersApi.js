...
export default class TransfersApi {
    ...
    */
     ...
     * @callback module:api/TransfersApi~getWithdrawsCallback
     ...
     * @param {String} [id] 
     * @param {module:api/TransfersApi~getWithdrawsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getWithdraws(page, pageSize, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * @callback module:api/TransfersApi~getWithdrawsByIdCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id 
     * @param {module:api/TransfersApi~getWithdrawsByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/TransfersApi~postWithdrawsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TransfersApi~postWithdrawsCallback} callback The callback function, accepting three arguments: error, data, response
