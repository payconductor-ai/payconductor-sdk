...
> getWithdraws(page, pageSize, opts)
...
let apiInstance = new PayconductorSdk.TransfersApi();
let page = 1; // Number | 
...
apiInstance.getWithdraws(page, pageSize, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
