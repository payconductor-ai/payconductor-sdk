...
namespace Org.OpenAPITools.Model
{
    ...
    /// Número de parcelas
    /// </summary>
    public partial class CartODeCrDitoInstallments : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CartODeCrDitoInstallments" /> class.
        /// </summary>
        /// <param name="int"></param>
        /// <param name="int1"></param>
        internal CartODeCrDitoInstallments(Option<int?> @int, Option<int?> int1)
        {
            IntOption = @int;
            Int1Option = int1;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CartODeCrDitoInstallments {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CartODeCrDitoInstallments" />
    /// </summary>
    public class CartODeCrDitoInstallmentsJsonConverter : JsonConverter<CartODeCrDitoInstallments>
    {
        /// <summary>
        /// Deserializes json to <see cref="CartODeCrDitoInstallments" />
        /// </summary>
        ...
        public override CartODeCrDitoInstallments Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CartODeCrDitoInstallments(varIntParsedValue, int1ParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="CartODeCrDitoInstallments" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cartODeCrDitoInstallments"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CartODeCrDitoInstallments cartODeCrDitoInstallments, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (cartODeCrDitoInstallments.IntOption.IsSet && cartODeCrDitoInstallments.IntOption.Value != null)
                writer.WriteString("expirationInSeconds", cartODeCrDitoInstallments.IntOption.Value);

            if (cartODeCrDitoInstallments.Int1Option.IsSet && cartODeCrDitoInstallments.Int1Option.Value != null)
                writer.WriteNumber("installments", cartODeCrDitoInstallments.Int1Option.Value.Value);

            WriteProperties(writer, cartODeCrDitoInstallments, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CartODeCrDitoInstallments" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cartODeCrDitoInstallments"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CartODeCrDitoInstallments cartODeCrDitoInstallments, JsonSerializerOptions jsonSerializerOptions)
        {
