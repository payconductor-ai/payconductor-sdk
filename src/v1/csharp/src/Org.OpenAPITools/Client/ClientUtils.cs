...
namespace Org.OpenAPITools.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is Cliente.DocumentTypeEnum clienteDocumentTypeEnum)
                return Cliente.DocumentTypeEnumToJsonValue(clienteDocumentTypeEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://app.payconductor.ai/api/v1";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "app.payconductor.ai";
