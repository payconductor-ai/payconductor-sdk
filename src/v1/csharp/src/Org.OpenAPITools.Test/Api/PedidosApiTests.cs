...
{
    /// <summary>
    ///  Class for testing PedidosApi
    /// </summary>
    public sealed class PedidosApiTests : ApiTestsBase
    {
        private readonly IPedidosApi _instance;

        public PedidosApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IPedidosApi>();
        }
