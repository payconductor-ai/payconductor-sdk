...
// APIClient manages communication with the PayConductor API API v1.0.0
...
type APIClient struct {
	...
	PedidosAPI *PedidosAPIService

	SaquesETransfernciasAPI *SaquesETransfernciasAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.PedidosAPI = (*PedidosAPIService)(&c.common)
	c.SaquesETransfernciasAPI = (*SaquesETransfernciasAPIService)(&c.common)
