...
------------ | ------------- | ------------- | -------------
**authorization_code** | **str** | Código de autorização da transação | [optional] 

## Example

```python
from openapi_client.models.post_orders200_response_credit_card import PostOrders200ResponseCreditCard
