...
class TestPostOrders200ResponseBankSlip(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostOrders200ResponseBankSlip:
        """Test PostOrders200ResponseBankSlip
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOrders200ResponseBankSlip`
        """
        model = PostOrders200ResponseBankSlip()
        if include_optional:
            return PostOrders200ResponseBankSlip(
                bar_code = '',
                digitable_line = '',
                pdf_url = ''
            )
    ...
    def testPostOrders200ResponseBankSlip(self):
        """Test PostOrders200ResponseBankSlip"""
