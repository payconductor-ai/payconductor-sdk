...
class TestPostOrders200ResponseNuPay(unittest.TestCase):
    """PostOrders200ResponseNuPay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostOrders200ResponseNuPay:
        """Test PostOrders200ResponseNuPay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOrders200ResponseNuPay`
        """
        model = PostOrders200ResponseNuPay()
        if include_optional:
            return PostOrders200ResponseNuPay(
                payment_url = ''
            )
        else:
            return PostOrders200ResponseNuPay(
    ...
    def testPostOrders200ResponseNuPay(self):
        """Test PostOrders200ResponseNuPay"""
