    ...
    def make_instance(self, include_optional) -> PostOrdersRequest:
        ...
        if include_optional:
            return PostOrdersRequest(
                charge_amount = 1.337,
                client_ip = '',
                customer = openapi_client.models.cliente.Cliente(
                    address = openapi_client.models.endereço_do_cliente.Endereço do cliente(
                        city = '', 
                        country = 'BR', 
                        neighborhood = '', 
                        number = '', 
                ...
                external_id = '',
                fingerprints = openapi_client.models.post_orders_request_fingerprints.postOrders_request_fingerprints(
                    threat_metrix_fingerprint_id = '', ),
                items = [
                    openapi_client.models.post_orders_request_items_inner.postOrders_request_items_inner(
                        id = '', 
                        is_physical = True, 
                        name = '', 
                        qty = 1.337, 
                ...
                merchant = openapi_client.models.merchant_input.MerchantInput(
                    document = '48072888001528', 
                    email = '', 
                    name = '01', ),
                payment = None,
                split_amount_total = 0,
                session = openapi_client.models.post_orders_request_session.postOrders_request_session(
