...
class TestCartODeCrDito(unittest.TestCase):
    """CartODeCrDito unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CartODeCrDito:
        """Test CartODeCrDito
