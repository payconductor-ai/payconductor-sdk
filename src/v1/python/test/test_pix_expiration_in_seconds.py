...
class TestPixExpirationInSeconds(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PixExpirationInSeconds:
        """Test PixExpirationInSeconds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PixExpirationInSeconds`
        """
        model = PixExpirationInSeconds()
        if include_optional:
            return PixExpirationInSeconds(
            )
        else:
            return PixExpirationInSeconds(
        )
    ...
    def testPixExpirationInSeconds(self):
        """Test PixExpirationInSeconds"""
