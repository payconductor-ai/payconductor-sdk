...
class TestPostOrders200ResponsePicPay(unittest.TestCase):
    """PostOrders200ResponsePicPay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostOrders200ResponsePicPay:
        """Test PostOrders200ResponsePicPay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOrders200ResponsePicPay`
        """
        model = PostOrders200ResponsePicPay()
        if include_optional:
            return PostOrders200ResponsePicPay(
                copy_and_paste_code = '',
                qr_code_url = ''
            )
        else:
    ...
    def testPostOrders200ResponsePicPay(self):
        """Test PostOrders200ResponsePicPay"""
