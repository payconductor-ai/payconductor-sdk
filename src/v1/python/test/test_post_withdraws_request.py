...
class TestPostWithdrawsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostWithdrawsRequest:
        """Test PostWithdrawsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostWithdrawsRequest`
        """
        model = PostWithdrawsRequest()
        if include_optional:
            return PostWithdrawsRequest(
                ...
                merchant = openapi_client.models.merchant_input.MerchantInput(
                    ...
                    email = '', 
                    name = '01', ),
                payout_account = openapi_client.models.post_withdraws_request_payout_account.postWithdraws_request_payoutAccount(
                    owner_document = '', 
                    owner_name = '', 
                    pix_key = '', 
                    pix_type = 'Cnpj', )
    ...
    def testPostWithdrawsRequest(self):
        """Test PostWithdrawsRequest"""
