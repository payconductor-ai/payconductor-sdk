...
class TestDadosCompletosDoCartOExpiration(unittest.TestCase):
    """DadosCompletosDoCartOExpiration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DadosCompletosDoCartOExpiration:
        """Test DadosCompletosDoCartOExpiration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DadosCompletosDoCartOExpiration`
        """
        model = DadosCompletosDoCartOExpiration()
        if include_optional:
            return DadosCompletosDoCartOExpiration(
                month = 1,
                year = 2025
            )
        else:
    ...
    def testDadosCompletosDoCartOExpiration(self):
        """Test DadosCompletosDoCartOExpiration"""
