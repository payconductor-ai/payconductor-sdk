...
class TestPostOrdersRequestSession(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostOrdersRequestSession:
        ...
        """
        model = PostOrdersRequestSession()
        if include_optional:
            return PostOrdersRequestSession(
    ...
    def testPostOrdersRequestSession(self):
        """Test PostOrdersRequestSession"""
