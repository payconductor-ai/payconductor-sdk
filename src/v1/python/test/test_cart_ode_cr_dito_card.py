...
class TestCartODeCrDitoCard(unittest.TestCase):
    """CartODeCrDitoCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CartODeCrDitoCard:
        """Test CartODeCrDitoCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CartODeCrDitoCard`
        """
        model = CartODeCrDitoCard()
        if include_optional:
            return CartODeCrDitoCard(
    ...
    def testCartODeCrDitoCard(self):
        """Test CartODeCrDitoCard"""
