...
class TestEndereODoCliente(unittest.TestCase):
    """EndereODoCliente unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndereODoCliente:
        """Test EndereODoCliente
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndereODoCliente`
        """
        model = EndereODoCliente()
        if include_optional:
            return EndereODoCliente(
                city = '',
                country = 'BR',
                neighborhood = '',
                number = '',
