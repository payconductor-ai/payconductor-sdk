...
class TestCartODeCrDitoInstallments(unittest.TestCase):
    """CartODeCrDitoInstallments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CartODeCrDitoInstallments:
        """Test CartODeCrDitoInstallments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CartODeCrDitoInstallments`
        """
        model = CartODeCrDitoInstallments()
        if include_optional:
            return CartODeCrDitoInstallments(
            )
        else:
            return CartODeCrDitoInstallments(
        )
    ...
    def testCartODeCrDitoInstallments(self):
        """Test CartODeCrDitoInstallments"""
