...
class TestPostWithdrawsRequestPayoutAccount(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostWithdrawsRequestPayoutAccount:
        """Test PostWithdrawsRequestPayoutAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostWithdrawsRequestPayoutAccount`
        """
        model = PostWithdrawsRequestPayoutAccount()
        if include_optional:
    ...
    def testPostWithdrawsRequestPayoutAccount(self):
        """Test PostWithdrawsRequestPayoutAccount"""
