...
class TestPostOrdersRequestPayment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostOrdersRequestPayment:
        ...
        if include_optional:
            return PostOrdersRequestPayment(
                ...
                nu_pay = openapi_client.models.nu_pay_nu_pay.NuPay_nuPay(
                    cancel_url = '', 
                    merchant_name = '', 
                    return_url = '', 
                    store_name = '', )
    ...
    def testPostOrdersRequestPayment(self):
        """Test PostOrdersRequestPayment"""
