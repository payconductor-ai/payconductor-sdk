...
class TestPostWithdraws200ResponsePayedAt(unittest.TestCase):
    """PostWithdraws200ResponsePayedAt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostWithdraws200ResponsePayedAt:
        """Test PostWithdraws200ResponsePayedAt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostWithdraws200ResponsePayedAt`
        """
        model = PostWithdraws200ResponsePayedAt()
        if include_optional:
            return PostWithdraws200ResponsePayedAt(
            )
        else:
            return PostWithdraws200ResponsePayedAt(
        )
    ...
    def testPostWithdraws200ResponsePayedAt(self):
        """Test PostWithdraws200ResponsePayedAt"""
