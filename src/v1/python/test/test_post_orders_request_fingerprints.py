...
class TestPostOrdersRequestFingerprints(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostOrdersRequestFingerprints:
        """Test PostOrdersRequestFingerprints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOrdersRequestFingerprints`
        """
        model = PostOrdersRequestFingerprints()
        if include_optional:
            return PostOrdersRequestFingerprints(
    ...
    def testPostOrdersRequestFingerprints(self):
        """Test PostOrdersRequestFingerprints"""
