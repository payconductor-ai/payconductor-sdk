...
class TestPostOrders200ResponsePix(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostOrders200ResponsePix:
        """Test PostOrders200ResponsePix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOrders200ResponsePix`
        """
        model = PostOrders200ResponsePix()
        if include_optional:
            return PostOrders200ResponsePix(
                copy_and_paste_code = '',
                qr_code_url = '',
                end_to_end_id = ''
            )
    ...
    def testPostOrders200ResponsePix(self):
        """Test PostOrders200ResponsePix"""
