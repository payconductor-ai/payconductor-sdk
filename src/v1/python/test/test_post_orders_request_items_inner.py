...
class TestPostOrdersRequestItemsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostOrdersRequestItemsInner:
        """Test PostOrdersRequestItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOrdersRequestItemsInner`
        """
        model = PostOrdersRequestItemsInner()
        if include_optional:
            return PostOrdersRequestItemsInner(
                id = '',
                is_physical = True,
                name = '',
                qty = 1.337,
    ...
    def testPostOrdersRequestItemsInner(self):
        """Test PostOrdersRequestItemsInner"""
