...
class TestPostWithdraws200ResponsePayoutAccount(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostWithdraws200ResponsePayoutAccount:
        """Test PostWithdraws200ResponsePayoutAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostWithdraws200ResponsePayoutAccount`
        """
        model = PostWithdraws200ResponsePayoutAccount()
        if include_optional:
            return PostWithdraws200ResponsePayoutAccount(
                id = '',
    ...
    def testPostWithdraws200ResponsePayoutAccount(self):
        """Test PostWithdraws200ResponsePayoutAccount"""
