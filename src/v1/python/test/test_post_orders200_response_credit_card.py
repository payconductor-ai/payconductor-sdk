...
class TestPostOrders200ResponseCreditCard(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostOrders200ResponseCreditCard:
        """Test PostOrders200ResponseCreditCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOrders200ResponseCreditCard`
        """
        model = PostOrders200ResponseCreditCard()
        if include_optional:
            return PostOrders200ResponseCreditCard(
                authorization_code = ''
            )
        else:
            return PostOrders200ResponseCreditCard(
    ...
    def testPostOrders200ResponseCreditCard(self):
        """Test PostOrders200ResponseCreditCard"""
