...
class TestCartOTokenizado(unittest.TestCase):
    """CartOTokenizado unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CartOTokenizado:
        """Test CartOTokenizado
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CartOTokenizado`
        """
        model = CartOTokenizado()
        if include_optional:
            return CartOTokenizado(
