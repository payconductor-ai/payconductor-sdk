...
from openapi_client.api.saques_e_transferncias_api import SaquesETransfernciasApi


class TestSaquesETransfernciasApi(unittest.TestCase):
    """SaquesETransfernciasApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SaquesETransfernciasApi()

    def tearDown(self) -> None:
        pass

    def test_get_withdraws(self) -> None:
        """Test case for get_withdraws

        Lista os saques
        """
        pass

    def test_get_withdraws_by_id(self) -> None:
        """Test case for get_withdraws_by_id

        Buscar pelo ID
        """
        pass

    def test_post_withdraws(self) -> None:
        """Test case for post_withdraws
