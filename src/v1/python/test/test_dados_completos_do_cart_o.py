...
class TestDadosCompletosDoCartO(unittest.TestCase):
    """DadosCompletosDoCartO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DadosCompletosDoCartO:
        """Test DadosCompletosDoCartO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DadosCompletosDoCartO`
        """
        model = DadosCompletosDoCartO()
        if include_optional:
            return DadosCompletosDoCartO(
                cvv = '012',
                expiration = openapi_client.models.dados_completos_do_cart_o_expiration.Dados_completos_do_cart_o_expiration(
                    month = 1, 
                    year = 2025, ),
                holder_name = '',
                number = ''
    ...
    def testDadosCompletosDoCartO(self):
        """Test DadosCompletosDoCartO"""
