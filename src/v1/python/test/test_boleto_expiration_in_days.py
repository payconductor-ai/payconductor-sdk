...
class TestBoletoExpirationInDays(unittest.TestCase):
    """BoletoExpirationInDays unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoletoExpirationInDays:
        """Test BoletoExpirationInDays
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoletoExpirationInDays`
        """
        model = BoletoExpirationInDays()
        if include_optional:
            return BoletoExpirationInDays(
            )
        else:
            return BoletoExpirationInDays(
        )
    ...
    def testBoletoExpirationInDays(self):
        """Test BoletoExpirationInDays"""
