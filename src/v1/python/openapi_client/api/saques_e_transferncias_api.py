...
class SaquesETransfernciasApi:
    ...
    def get_withdraws(
        ...
        _param = self._get_withdraws_serialize(
            period=period,
            page=page,
            page_size=page_size,
            end_date=end_date,
    ...
    @validate_call
    def get_withdraws_with_http_info(
        self,
        period: StrictStr,
        page: Union[Annotated[float, Field(multiple_of=1, strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]],
        page_size: Union[Annotated[float, Field(multiple_of=1, le=100, strict=True, ge=1)], Annotated[int, Field(le=100, strict=True, ge=1)]],
    ...
    @validate_call
    def get_withdraws_without_preload_content(
        self,
        period: StrictStr,
        page: Union[Annotated[float, Field(multiple_of=1, strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]],
        page_size: Union[Annotated[float, Field(multiple_of=1, le=100, strict=True, ge=1)], Annotated[int, Field(le=100, strict=True, ge=1)]],
    ...
    def get_withdraws_by_id(
        ...
        _param = self._get_withdraws_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_withdraws_by_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_withdraws_by_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_withdraws_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def post_withdraws(
        ...
        :param post_withdraws_request: (required)
        :type post_withdraws_request: PostWithdrawsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_withdraws_serialize(
            post_withdraws_request=post_withdraws_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_withdraws_with_http_info(
        self,
        post_withdraws_request: PostWithdrawsRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostWithdraws200Response]:
        """Cria saque
    ...
    @validate_call
    def post_withdraws_without_preload_content(
        self,
        post_withdraws_request: PostWithdrawsRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_withdraws_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if post_withdraws_request is not None:
            _body_params = post_withdraws_request
