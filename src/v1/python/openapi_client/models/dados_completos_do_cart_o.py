...
class DadosCompletosDoCartO(BaseModel):
    """
    DadosCompletosDoCartO
    """ # noqa: E501
    cvv: Annotated[str, Field(min_length=3, strict=True, max_length=4)] = Field(description="Código de segurança do cartão (CVV)")
    expiration: DadosCompletosDoCartOExpiration
    holder_name: StrictStr = Field(description="Nome do titular do cartão", alias="holderName")
    number: StrictStr = Field(description="Número do cartão de crédito")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cvv": obj.get("cvv"),
            "expiration": DadosCompletosDoCartOExpiration.from_dict(obj["expiration"]) if obj.get("expiration") is not None else None,
