...
class Boleto(BaseModel):
    ...
    expiration_in_days: Optional[BoletoExpirationInDays] = Field(default=None, alias="expirationInDays")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of expiration_in_days
        if self.expiration_in_days:
            _dict['expirationInDays'] = self.expiration_in_days.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expirationInDays": BoletoExpirationInDays.from_dict(obj["expirationInDays"]) if obj.get("expirationInDays") is not None else None
        })
        return _obj
