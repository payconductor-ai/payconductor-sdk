  ...
  public = list(
    ...
    DeleteCustomersByIdWithHttpInfo = function(id, ...) {
      ...
      if (!missing(`id`) && is.null(`id`)) {
        stop("Invalid value for `id` when calling CustomerApi$DeleteCustomersById, `id` is not nullable")
      }
    ...
    GetCustomersWithHttpInfo = function(page, page_size, period, email = NULL, name = NULL, end_date = NULL, start_date = NULL, ...) {
      ...
      if (!is.null(`page`) && `page` <  1) {
        stop("Invalid value for `page` when calling CustomerApi$GetCustomers, must be bigger than or equal to 1.")
      }
      ...
      if (!is.null(`page_size`) && `page_size` >  100) {
        stop("Invalid value for `page_size` when calling CustomerApi$GetCustomers, must be smaller than or equal to 100.")
      }
      if (!is.null(`page_size`) && `page_size` <  1) {
        stop("Invalid value for `page_size` when calling CustomerApi$GetCustomers, must be bigger than or equal to 1.")
      }

      if (!missing(`period`) && is.null(`period`)) {
        stop("Invalid value for `period` when calling CustomerApi$GetCustomers, `period` is not nullable")
      }

      if (!missing(`email`) && is.null(`email`)) {
        stop("Invalid value for `email` when calling CustomerApi$GetCustomers, `email` is not nullable")
      }

      if (!missing(`name`) && is.null(`name`)) {
        stop("Invalid value for `name` when calling CustomerApi$GetCustomers, `name` is not nullable")
      }
      if (!is.null(`name`) && nchar(`name`) > 255) {
        stop("Invalid length for `name` when calling CustomerApi$GetCustomers, must be smaller than or equal to 255.")
      }
      if (!is.null(`name`) && nchar(`name`) < 1) {
        stop("Invalid length for `name` when calling CustomerApi$GetCustomers, must be bigger than or equal to 1.")
      }

      if (!missing(`end_date`) && is.null(`end_date`)) {
        stop("Invalid value for `end_date` when calling CustomerApi$GetCustomers, `end_date` is not nullable")
      }

      if (!missing(`start_date`) && is.null(`start_date`)) {
        stop("Invalid value for `start_date` when calling CustomerApi$GetCustomers, `start_date` is not nullable")
      }
      ...
      if (!is.null(`period`) && !(`period` %in% c("Today", "Yesterday", "Last7Days", "Last30Days", "ThisMonth", "LastMonth", "ThisYear", "Custom"))) {
        stop("Invalid value for period when calling CustomerApi$GetCustomers. Must be [Today, Yesterday, Last7Days, Last30Days, ThisMonth, LastMonth, ThisYear, Custom].")
      }
    ...
    GetCustomersByIdWithHttpInfo = function(id, ...) {
      ...
      if (!missing(`id`) && is.null(`id`)) {
        stop("Invalid value for `id` when calling CustomerApi$GetCustomersById, `id` is not nullable")
      }
    ...
    PatchCustomersByIdWithHttpInfo = function(id, customer1, ...) {
      ...
      if (!missing(`id`) && is.null(`id`)) {
        stop("Invalid value for `id` when calling CustomerApi$PatchCustomersById, `id` is not nullable")
      }

      if (!missing(`customer1`) && is.null(`customer1`)) {
        stop("Invalid value for `customer1` when calling CustomerApi$PatchCustomersById, `customer1` is not nullable")
      }
    ...
    PostCustomersWithHttpInfo = function(customer, ...) {
      ...
      if (!missing(`customer`) && is.null(`customer`)) {
        stop("Invalid value for `customer` when calling CustomerApi$PostCustomers, `customer` is not nullable")
      }
