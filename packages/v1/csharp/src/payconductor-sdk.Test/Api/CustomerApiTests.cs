...
namespace payconductor-sdk.Test.Api
{
    ...
    public sealed class CustomerApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test DeleteCustomersById
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteCustomersByIdAsyncTest()
        {
            string id = default!;
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetCustomersByIdAsyncTest()
        {
            string id = default!;
        }

        /// <summary>
        /// Test PatchCustomersById
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task PatchCustomersByIdAsyncTest()
        {
            string id = default!;
            Customer1 customer1 = default!;
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task PostCustomersAsyncTest()
        {
