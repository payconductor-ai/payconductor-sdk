...
namespace payconductor-sdk.Test.Api
{
    ...
    /// </summary>
    public sealed class TransferApiTests : ApiTestsBase
    {
        private readonly ITransferApi _instance;

        public TransferApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ITransferApi>();
        }
