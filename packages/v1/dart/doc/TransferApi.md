...
try {
    ...
    print('Exception when calling TransferApi->getWithdraws: $e\n');
}
```
...
try {
    ...
    print('Exception when calling TransferApi->getWithdrawsById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling TransferApi->postWithdraws: $e\n');
}
```
