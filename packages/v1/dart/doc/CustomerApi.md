...
try {
    ...
    print('Exception when calling CustomerApi->deleteCustomersById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->patchCustomersById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->postCustomers: $e\n');
}
```
