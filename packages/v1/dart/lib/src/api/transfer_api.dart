...
class TransferApi {
  ...
  Future<Response<void>> getWithdraws({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getWithdrawsById({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/withdraws/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PostWithdraws200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PostWithdraws200Response>> postWithdraws({ 
    required PostWithdrawsRequest postWithdrawsRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PostWithdrawsRequest);
      _bodyData = _serializers.serialize(postWithdrawsRequest, specifiedType: _type);
    ...
    PostWithdraws200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostWithdraws200Response),
      ) as PostWithdraws200Response;
    ...
    return Response<PostWithdraws200Response>(
      data: _responseData,
