...
conf = payconductor_sdk.Configuration(
    username='the-user',
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://app.payconductor.ai/api/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("payconductor_sdk")
