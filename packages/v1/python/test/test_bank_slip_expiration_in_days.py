...
class TestBankSlipExpirationInDays(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BankSlipExpirationInDays:
        """Test BankSlipExpirationInDays
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankSlipExpirationInDays`
        """
        model = BankSlipExpirationInDays()
        if include_optional:
            return BankSlipExpirationInDays(
            )
        else:
            return BankSlipExpirationInDays(
        )
    ...
    def testBankSlipExpirationInDays(self):
        """Test BankSlipExpirationInDays"""
