...
class TestPostCardTokenizationRequestCustomerAnyOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostCardTokenizationRequestCustomerAnyOf:
        """Test PostCardTokenizationRequestCustomerAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostCardTokenizationRequestCustomerAnyOf`
        """
        model = PostCardTokenizationRequestCustomerAnyOf()
        if include_optional:
            return PostCardTokenizationRequestCustomerAnyOf(
                id = ''
            )
        else:
            return PostCardTokenizationRequestCustomerAnyOf(
    ...
    def testPostCardTokenizationRequestCustomerAnyOf(self):
        """Test PostCardTokenizationRequestCustomerAnyOf"""
