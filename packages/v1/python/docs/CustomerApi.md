...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CustomerApi->delete_customers_by_id: %s\n" % e)
```
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CustomerApi->get_customers_by_id: %s\n" % e)
```
...
with payconductor_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CustomerApi->patch_customers_by_id: %s\n" % e)
```
