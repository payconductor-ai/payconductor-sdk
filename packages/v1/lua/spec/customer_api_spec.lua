...
--[[
Unit tests for payconductor-sdk.api.customer_api
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("customer_api", function()
  local payconductor-sdk_customer_api = require "payconductor-sdk.api.customer_api"
  -- unit tests for delete_customers_by_id
  describe("delete_customers_by_id test", function()
  ...
  describe("get_customers test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
  ...
  describe("get_customers_by_id test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
  ...
  describe("patch_customers_by_id test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
  ...
  describe("post_customers test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
