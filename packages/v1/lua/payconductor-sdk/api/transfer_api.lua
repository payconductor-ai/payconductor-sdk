...
local transfer_api = {}
local transfer_api_mt = {
	__name = "transfer_api";
	__index = transfer_api;
}

local function new_transfer_api(authority, basePath, schemes)
	local schemes_map = {}
...
function transfer_api:get_withdraws(period, page, page_size, end_date, start_date, id)
...
function transfer_api:get_withdraws_by_id(id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function transfer_api:post_withdraws(post_withdraws_request)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
