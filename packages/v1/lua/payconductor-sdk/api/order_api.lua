...
function order_api:get_orders(period, page, page_size, end_date, start_date, id, status)
...
function order_api:get_orders_by_id(id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function order_api:post_orders(post_orders_request)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
...
function order_api:post_orders_by_id_refund(id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
