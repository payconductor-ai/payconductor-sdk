...
try {
    ...
    println("4xx response calling TransferApi#getWithdraws")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling TransferApi#getWithdraws")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling TransferApi#getWithdrawsById")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling TransferApi#getWithdrawsById")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling TransferApi#postWithdraws")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling TransferApi#postWithdraws")
    e.printStackTrace()
}
```
