...
try {
    ...
    println("4xx response calling OrderApi#getOrdersById")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OrderApi#getOrdersById")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OrderApi#postOrders")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OrderApi#postOrders")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling OrderApi#postOrdersByIdRefund")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling OrderApi#postOrdersByIdRefund")
    e.printStackTrace()
}
```
