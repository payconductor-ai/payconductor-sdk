...
if ($@) {
    warn "Exception when calling CustomerApi->delete_customers_by_id: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling CustomerApi->get_customers_by_id: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling CustomerApi->patch_customers_by_id: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling CustomerApi->post_customers: $@\n";
}
```
