# WWW::OpenAPIClient::TransferApi

## Load the API package
```perl
use WWW::OpenAPIClient::Object::TransferApi;
```
...
my $api_instance = WWW::OpenAPIClient::TransferApi->new(
...
if ($@) {
    warn "Exception when calling TransferApi->get_withdraws: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling TransferApi->get_withdraws_by_id: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling TransferApi->post_withdraws: $@\n";
}
```
