...
func (a *OrderAPIService) GetOrdersExecute(r ApiGetOrdersRequest) (*http.Response, error) {
	var (
...
*/
func (a *OrderAPIService) GetOrdersById(ctx context.Context, id string) ApiGetOrdersByIdRequest {
	return ApiGetOrdersByIdRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *OrderAPIService) GetOrdersByIdExecute(r ApiGetOrdersByIdRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrderAPIService.GetOrdersById")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *OrderAPIService) PostOrders(ctx context.Context) ApiPostOrdersRequest {
	return ApiPostOrdersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OrderAPIService) PostOrdersExecute(r ApiPostOrdersRequest) (*PostOrders200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrderAPIService.PostOrders")
	if err != nil {
...
*/
func (a *OrderAPIService) PostOrdersByIdRefund(ctx context.Context, id string) ApiPostOrdersByIdRefundRequest {
	return ApiPostOrdersByIdRefundRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *OrderAPIService) PostOrdersByIdRefundExecute(r ApiPostOrdersByIdRefundRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrderAPIService.PostOrdersByIdRefund")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
