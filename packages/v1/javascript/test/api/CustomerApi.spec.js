...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PayconductorSdk.CustomerApi();
  });
  ...
  describe('CustomerApi', function() {
    describe('deleteCustomersById', function() {
      it('should call deleteCustomersById successfully', function(done) {
        //uncomment below and update the code to test deleteCustomersById
        //instance.deleteCustomersById(function(error) {
