...
export default class TransferApi {
    ...
    */
     ...
     * @callback module:api/TransferApi~getWithdrawsCallback
     ...
     * @param {String} [id] 
     * @param {module:api/TransferApi~getWithdrawsCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/TransferApi~getWithdrawsByIdCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id 
     * @param {module:api/TransferApi~getWithdrawsByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/TransferApi~postWithdrawsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TransferApi~postWithdrawsCallback} callback The callback function, accepting three arguments: error, data, response
