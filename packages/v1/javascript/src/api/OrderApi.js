...
export default class OrderApi {
    ...
    */
     ...
     * @callback module:api/OrderApi~getOrdersByIdCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id 
     * @param {module:api/OrderApi~getOrdersByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/OrderApi~postOrdersCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/OrderApi~postOrdersCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/OrderApi~postOrdersByIdRefundCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id 
     * @param {module:api/OrderApi~postOrdersByIdRefundCallback} callback The callback function, accepting three arguments: error, data, response
     */
