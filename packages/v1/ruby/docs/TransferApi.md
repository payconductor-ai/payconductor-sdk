# OpenapiClient::TransferApi

All URIs are relative to *https://app.payconductor.ai/api/v1*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**get_withdraws**](TransferApi.md#get_withdraws) | **GET** /withdraws/ | List withdrawals |
| [**get_withdraws_by_id**](TransferApi.md#get_withdraws_by_id) | **GET** /withdraws/{id} | Get withdrawal by ID |
| [**post_withdraws**](TransferApi.md#post_withdraws) | **POST** /withdraws/ | Create withdrawal |
...
api_instance = OpenapiClient::TransferApi.new
period = 'Today' # String | 
page = 8.14 # Float | 
...
begin
  ...
  puts "Error when calling TransferApi->get_withdraws: #{e}"
end
```
...
begin
  ...
  puts "Error when calling TransferApi->get_withdraws_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling TransferApi->get_withdraws_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling TransferApi->get_withdraws_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling TransferApi->post_withdraws: #{e}"
end
```
...
begin
  ...
  puts "Error when calling TransferApi->post_withdraws_with_http_info: #{e}"
end
```
